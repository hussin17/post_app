...
var require_dist2 = __commonJS({
  "node_modules/@inertiajs/inertia-vue3/dist/index.js"(exports) {
    ...
    function a() {
      var e2 = [].slice.call(arguments), a2 = "string" == typeof e2[0] ? e2[0] : null, u2 = ("string" == typeof e2[0] ? e2[1] : e2[0]) || {}, s2 = a2 ? o.Inertia.restore(a2) : null, c2 = n(u2), l2 = null, p2 = null, f2 = function(e3) {
        ...
        var s3 = f2(this.data()), d3 = i({}, t2, { onCancelToken: function(e4) {
          ...
          if (u3.processing = false, u3.progress = null, u3.errors = e4, u3.hasErrors = true, t2.onError)
        ...
        Object.assign(this, e3.data), Object.assign(this.errors, e3.errors), this.hasErrors = Object.keys(this.errors).length > 0;
      } }));
    ...
    var m = { props: { title: { type: String, required: false } }, data: function() {
    ...
    var h = { name: "InertiaLink", props: { as: { type: String, default: "a" }, data: { type: Object, default: function() {
      return {};
      ...
      return {};
    } } }, setup: function(e2, r2) {
      var n2 = r2.slots, a2 = r2.attrs;
      return function(e3) {
        var r3 = e3.as.toLowerCase(), u2 = e3.method.toLowerCase(), s2 = o.mergeDataIntoQueryString(u2, e3.href || "", e3.data), c2 = s2[0], l2 = s2[1];
        return "a" === r3 && "get" !== u2 && console.warn('Creating POST/PUT/PATCH/DELETE <a> links is discouraged as it causes "Open Link in New Tab/Window" accessibility issues.\n\nPlease specify a more appropriate element using the "as" attribute. For example:\n\n<inertia-link href="' + c2 + '" method="' + u2 + '" as="button">...</inertia-link>'), t.h(e3.as, i({}, a2, "a" === r3 ? { href: c2 } : {}, { onClick: function(r4) {
          var t2;
    ...
    exports.App = f, exports.Head = m, exports.InertiaApp = f, exports.InertiaHead = m, exports.InertiaLink = h, exports.Link = h, exports.app = f, exports.createInertiaApp = function(e2) {
      try {
        var r2, n2, o2, i2, a2, u2, s2;
        n2 = void 0 === (r2 = e2.id) ? "app" : r2, o2 = e2.resolve, i2 = e2.setup, a2 = e2.title, u2 = e2.page, s2 = e2.render;
        var c2 = "undefined" == typeof window, l2 = c2 ? null : document.getElementById(n2), p2 = u2 || JSON.parse(l2.dataset.page), m2 = function(e3) {
          return Promise.resolve(o2(e3)).then(function(e4) {
            return e4.default || e4;
          });
        }, h2 = [];
        return Promise.resolve(m2(p2.component).then(function(e3) {
          return i2({ el: l2, app: f, App: f, props: { initialPage: p2, initialComponent: e3, resolveComponent: m2, titleCallback: a2, onHeadUpdate: c2 ? function(e4) {
            return h2 = e4;
          } : null }, plugin: d });
        })).then(function(e3) {
          return function() {
    ...
    }, exports.link = h, exports.plugin = d, exports.useForm = a, exports.usePage = function() {
