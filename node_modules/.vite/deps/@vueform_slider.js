...
var x = d(h(function(t, e) {
  !function(t2) {
    ...
    function O(t3, e3, r2) {
      ...
      return a2 + E2([i2, o2], r2) / w2(a2, s2);
    }
    function k(t3, e3, r2) {
      if (r2 >= 100)
        return t3.slice(-1)[0];
    ...
    function st(e3, r2, s2) {
      var u3, d3, S2, w3, P3, E3 = b2(), N2 = x2() && y2(), C2 = e3, O2 = r2.spectrum, k2 = [], V2 = [], A2 = [], j2 = 0, M2 = {}, U2 = e3.ownerDocument, D2 = r2.documentElement || U2.documentElement, T2 = U2.body, z2 = "rtl" === U2.dir || 1 === r2.ort ? 0 : 100;
      function F2(t3, e4) {
      ...
      function rt2(t3, e4, n2, i2) {
        var o2 = function(o3) {
          ...
          return !!a3 && !(X2() && !i2.doNotReject) && !(v2(C2, r2.cssClasses.tap) && !i2.doNotReject) && !(t3 === E3.start && void 0 !== a3.buttons && a3.buttons > 1) && (!i2.hover || !a3.buttons) && (N2 || a3.preventDefault(), a3.calcPoint = a3.points[r2.ort], void n2(a3, i2));
        }, a2 = [];
      ...
      function ut2(t3, e4) {
        ...
        }), 0 === j2 && (m2(C2, r2.cssClasses.drag), Et(), t3.cursor && (T2.style.cursor = "", T2.removeEventListener("selectstart", o))), e4.handleNumbers.forEach(function(t4) {
      ...
      function ct(t3, e4) {
        if (!e4.handleNumbers.some(Y2)) {
          var n2;
          1 === e4.handleNumbers.length && (n2 = d3[e4.handleNumbers[0]].children[0], j2 += 1, h2(n2, r2.cssClasses.active)), t3.stopPropagation();
          var i2 = [], a2 = rt2(E3.move, D2, lt2, { target: t3.target, handle: n2, connect: e4.connect, listeners: i2, startCalcPoint: t3.calcPoint, baseSize: et2(), pageOffset: t3.pageOffset, handleNumbers: e4.handleNumbers, buttonsProperty: t3.buttons, locations: V2.slice() }), s3 = rt2(E3.end, D2, ut2, { target: t3.target, handle: n2, listeners: i2, doNotReject: true, handleNumbers: e4.handleNumbers }), l2 = rt2("mouseout", D2, st2, { target: t3.target, handle: n2, listeners: i2, doNotReject: true, handleNumbers: e4.handleNumbers });
      ...
      function ft(t3) {
        ...
        Object.keys(M2).forEach(function(t4) {
          "hover" === t4.split(".")[0] && M2[t4].forEach(function(t5) {
            t5.call(zt, n2);
          });
        });
      }
        ...
        t3.fixed || d3.forEach(function(t4, e4) {
          ...
          if (false !== e4 && 0 !== n2 && n2 !== S2.length - 1) {
            ...
            h2(e4, r2.cssClasses.draggable), t3.fixed && (a2.push(i2.children[0]), a2.push(o2.children[0])), t3.dragAll && (s3 = d3, l2 = A2), a2.forEach(function(t4) {
              rt2(E3.start, t4, ct, { handles: s3, handleNumbers: l2, connect: e4 });
            });
          }
        });
      }
      function mt(t3, e4) {
        M2[t3] = M2[t3] || [], M2[t3].push(e4), "update" === t3.split(".")[0] && d3.forEach(function(t4, e5) {
          bt("update", e5);
        });
      }
      function vt(t3) {
      ...
      function bt(t3, e4, n2) {
        Object.keys(M2).forEach(function(i2) {
          var o2 = i2.split(".")[0];
          t3 === o2 && M2[i2].forEach(function(t4) {
      ...
      function Lt(t3, e4) {
        var n2 = jt(), o2 = ["margin", "limit", "padding", "range", "animate", "snap", "step", "format", "pips", "tooltips"];
...
function P(t) {
  return P = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t2) {
    return typeof t2;
  } : function(t2) {
    return t2 && "function" == typeof Symbol && t2.constructor === Symbol && t2 !== Symbol.prototype ? "symbol" : typeof t2;
  }, P(t);
}
var E = { name: "Slider", emits: ["input", "update:modelValue", "update", "change"], props: { ...{ value: { validator: function(t) {
  ...
  const l = function(r, n, i) {
    ...
    var c3 = toRefs(a2), p2 = c3.orientation, f3 = c3.direction, d3 = c3.tooltips, h2 = c3.step, m2 = c3.min, v2 = c3.max, g2 = c3.merge, b2 = c3.id, y2 = c3.disabled, S2 = c3.options, E2 = c3.classes, N = c3.format, C = c3.lazy, O = l2.value, k = l2.initialValue, V = l2.tooltipsFormat, A = l2.tooltipsMerge, j = l2.classList, M = ref(null), U = ref(null), D = ref(false), L = computed(function() {
      ...
      U.value = x.create(M.value, Object.assign({}, L.value, S2.value)), d3.value && z.value && g2.value >= 0 && A(M.value, g2.value, " - "), U.value.on("set", function(t) {
        var e = F();
        s2.emit("change", e), C.value && q(e);
      }), U.value.on("update", function(t) {
        if (D.value) {
          var e = F();
          z.value && w(O.value, e) || !z.value && O.value == e ? s2.emit("update", e) : C.value || q(e);
        }
    ...
    return onMounted(R), onUnmounted(B), watch(O, function(t, e) {
      e && ("object" === P(e) && "object" === P(t) && t && Object.keys(e) > Object.keys(t) || "object" === P(e) && "object" !== P(t) || !t) && _();
