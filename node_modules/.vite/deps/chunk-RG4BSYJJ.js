...
var require_dist = __commonJS({
  "node_modules/@inertiajs/inertia/dist/index.js"(exports) {
    ...
    function h(e2, t2, r2) {
      var o2 = t2.toString().includes("http"), s2 = o2 || t2.toString().startsWith("/"), a2 = !s2 && !t2.toString().startsWith("#") && !t2.toString().startsWith("?"), c2 = t2.toString().includes("?") || e2 === exports.Method.GET && Object.keys(r2).length, l2 = t2.toString().includes("#"), d2 = new URL(t2.toString(), "http://localhost");
      return e2 === exports.Method.GET && Object.keys(r2).length && (d2.search = n.stringify(i(n.parse(d2.search, { ignoreQueryPrefix: true }), r2), { encodeValuesOnly: true, arrayFormat: "brackets" }), r2 = {}), [[o2 ? d2.protocol + "//" + d2.host : "", s2 ? d2.pathname : "", a2 ? d2.pathname.substring(1) : "", c2 ? d2.search : "", l2 ? d2.hash : ""].join(""), r2];
    }
    function p(e2) {
    ...
    var g = function() {
      ...
      return n2.init = function(e3) {
        ...
        var i2 = this, o2 = void 0 === n3 ? {} : n3, a2 = o2.method, l2 = void 0 === a2 ? exports.Method.GET : a2, d2 = o2.data, v2 = void 0 === d2 ? {} : d2, m2 = o2.replace, g2 = void 0 !== m2 && m2, w2 = o2.preserveScroll, S2 = void 0 !== w2 && w2, y = o2.preserveState, b = void 0 !== y && y, E = o2.only, P = void 0 === E ? [] : E, I = o2.headers, x = void 0 === I ? {} : I, V = o2.errorBag, T = void 0 === V ? "" : V, L = o2.forceFormData, O = void 0 !== L && L, C = o2.onCancelToken, k = void 0 === C ? function() {
        ...
        if (!function e4(t2) {
          ...
          var K = h(l2, J, v2), _ = K[1];
          J = u(K[0]), v2 = _;
        }
        var z = { url: J, method: l2, data: v2, replace: g2, preserveScroll: S2, preserveState: b, only: P, headers: x, errorBag: T, forceFormData: O, cancelled: false, completed: false, interrupted: false };
        if (false !== R(z) && function(e4) {
          ...
          this.activeVisit = r({}, z, { onCancelToken: k, onBefore: R, onStart: A, onProgress: D, onFinish: N, onCancel: q, onSuccess: G, onError: X, cancelToken: t.CancelToken.source() }), k({ cancel: function() {
            i2.activeVisit && i2.cancelVisit(i2.activeVisit, { cancelled: true });
          } }), function(e4) {
            f("start", { detail: { visit: e4 } });
          }(z), A(z), t({ method: l2, url: p(J).href, data: l2 === exports.Method.GET ? {} : v2, params: l2 === exports.Method.GET ? v2 : {}, cancelToken: this.activeVisit.cancelToken.token, headers: r({}, x, { Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true }, P.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": P.join(",") } : {}, T && T.length ? { "X-Inertia-Error-Bag": T } : {}, this.page.version ? { "X-Inertia-Version": this.page.version } : {}), onUploadProgress: function(e4) {
            ...
            var n4 = e4.data;
            P.length && n4.component === i2.page.component && (n4.props = r({}, i2.page.props, n4.props)), S2 = i2.resolvePreserveOption(S2, n4), (b = i2.resolvePreserveOption(b, n4)) && null != (t2 = window.history.state) && t2.rememberedState && n4.component === i2.page.component && (n4.rememberedState = window.history.state.rememberedState);
            var o3 = J, s2 = u(n4.url);
            return o3.hash && !s2.hash && p(o3).href === s2.href && (s2.hash = o3.hash, n4.url = s2.href), i2.setPage(n4, { visitId: Q, replace: g2, preserveScroll: S2, preserveState: b });
          }).then(function() {
            ...
            if (i2.isInertiaResponse(e4.response))
              return i2.setPage(e4.response.data, { visitId: Q });
            if (i2.isLocationVisitResponse(e4.response)) {
              var t2 = u(e4.response.headers["x-inertia-location"]), n4 = J;
              n4.hash && !t2.hash && p(n4).href === t2.href && (t2.hash = n4.hash), i2.locationVisit(t2, true === S2);
            } else {
              if (!e4.response)
        ...
        var n3;
        void 0 === t2 && (t2 = "default"), this.replaceState(r({}, this.page, { rememberedState: r({}, this.page.rememberedState, (n3 = {}, n3[t2] = e3, n3)) }));
      }, n2.restore = function(e3) {
        var t2, n3;
        return void 0 === e3 && (e3 = "default"), null == (t2 = window.history.state) || null == (n3 = t2.rememberedState) ? void 0 : n3[e3];
    ...
    var w = { buildDOMElement: function(e2) {
...
//# sourceMappingURL=chunk-RG4BSYJJ.js.map
