...
(function() {
  ...
  function Ca(a) {
    for (var b in Ba)
      if (Ba[b].id === a)
        return a = Ba[b], { firebaseEndpoint: a.Sa, secureTokenEndpoint: a.Ya, identityPlatformEndpoint: a.Va };
    return null;
  }
  var Da;
  ...
  function Jc(a) {
    return new D(function(b) {
      var c = a.length, d = [];
      if (c)
        for (var e = function(h, n, p) {
          c--;
          d[h] = n ? { Ob: true, value: p } : { Ob: false, reason: p };
          0 == c && b(d);
        }, f = 0, g; f < a.length; f++)
  ...
  hd.prototype.add = function(a, b, c, d, e) {
    ...
    a || (a = this.a[f] = [], this.b++);
    var g = id(a, b, d, e);
    -1 < g ? (b = a[g], c || (b.Oa = false)) : (b = new fd(b, this.src, f, !!d, e), b.Oa = c, a.push(b));
    return b;
  };
  function jd(a, b) {
    var c = b.type;
  ...
  function nd(a, b, c, d, e) {
    if (d && d.once)
      ...
      c = pd(c), a && a[dd] ? qd(a, b, c, m(d) ? !!d.capture : !!d, e) : rd(a, b, c, false, d, e);
  }
  function rd(a, b, c, d, e, f) {
    if (!b)
      throw Error("Invalid event type");
    var g = m(e) ? !!e.capture : !!e, h = sd(a);
    h || (a[kd] = h = new hd(a));
    c = h.add(b, c, d, g, f);
    if (!c.proxy) {
      d = td();
  ...
  function od(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      c = pd(c), a && a[dd] ? wd(a, b, c, m(d) ? !!d.capture : !!d, e) : rd(a, b, c, true, d, e);
  }
    ...
    if (a = sd(a)) {
      if (b = a.a[b.toString()])
        for (b = b.concat(), a = 0; a < b.length; a++) {
          var f = b[a];
          f && f.capture == c && !f.va && (f = zd(f, d), e = e && false !== f);
        }
    }
    return e;
  }
    ...
    if (!Zc) {
      ...
      if (!(0 > d.keyCode || void 0 != d.returnValue)) {
        ...
        for (e = d.length - 1; 0 <= e; e--) {
          b.b = d[e];
          var f = yd(d[e], a, true, b);
          c = c && f;
        }
        for (e = 0; e < d.length; e++)
          b.b = d[e], f = yd(d[e], a, false, b), c = c && f;
      }
      return c;
    }
    return zd(
  ...
  function Nd(a, b) {
    ...
    this.h = false;
    var c;
    a instanceof Nd ? (this.h = void 0 !== b ? b : a.h, Od(this, a.f), this.l = a.l, this.a = a.a, Pd(this, a.g), this.c = a.c, Qd(this, Rd(a.b)), this.i = a.i) : a && (c = String(a).match(Ld)) ? (this.h = !!b, Od(this, c[1] || "", true), this.l = Sd(c[2] || ""), this.a = Sd(c[3] || "", true), Pd(this, c[4]), this.c = Sd(c[5] || "", true), Qd(this, c[6] || "", true), this.i = Sd(c[7] || "")) : (this.h = !!b, this.b = new Td(null, this.h));
  }
  Nd.prototype.toString = function() {
    var a = [], b = this.f;
    b && a.push(Ud(b, Vd, true), ":");
    var c = this.a;
    if (c || "file" == b)
      a.push("//"), (b = this.l) && a.push(Ud(b, Vd, true), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.g, null != c && a.push(":", String(c));
    if (c = this.c)
      this.a && "/" != c.charAt(0) && a.push("/"), a.push(Ud(c, "/" == c.charAt(0) ? Wd : Xd, true));
  ...
  function Jf(a) {
    a = be(a);
    var b = ae(a, Kf) || null, c = ae(a, Lf) || null, d = ae(a, Mf) || null;
    d = d ? Nf[d] || null : null;
    if (!b || !c || !d)
      throw new t("argument-error", Kf + ", " + Lf + "and " + Mf + " are required in a valid action code URL.");
    N(this, { apiKey: b, operation: d, code: c, continueUrl: ae(a, Of) || null, languageCode: ae(a, Pf) || null, tenantId: ae(a, Qf) || null });
  }
  ...
  r(sg, ug);
  function xg(a) {
    var b = be(a), c = ae(b, "link"), d = ae(be(c), "link");
    b = ae(b, "deep_link_id");
  ...
  sh.prototype.w = function() {
    return { type: this.c, eventId: this.b, urlResponse: this.g, sessionId: this.f, postBody: this.h, tenantId: this.i, error: this.a && this.a.w() };
  };
  function th(a) {
    a = a || {};
  ...
  k.send = function(a) {
    ...
    this.a = true;
    var b = { headers: this.l, method: this.s, credentials: this.i, cache: void 0 };
    a && (b.body = a);
  ...
  function ai(a) {
    ...
    this.f = this.N = this.h = this.G = false;
    this.g = 0;
    this.s = null;
    this.m = bi;
    this.u = this.R = false;
  ...
  function ei(a, b, c, d, e) {
    ...
    try {
      hi(a), 0 < a.g && (a.u = ii(a.a), Uh(a.b, fi(a, "Will abort after " + a.g + "ms if incomplete, xhr2 " + a.u)), a.u ? (a.a.timeout = a.g, a.a.ontimeout = q(a.Ma, a)) : a.s = Dd(a.Ma, a.g, a)), Uh(a.b, fi(a, "Sending request")), a.h = true, a.a.send(b), a.h = false;
    } catch (g) {
      Uh(
        a.b,
  ...
  pi.prototype.cancel = function(a) {
    if (this.a)
      ...
      this.u ? this.u.call(this.s, this) : this.m = true;
  ...
  function ui(a) {
    ...
    b = a.c;
    for (var d = c = false; a.g.length && !a.h; ) {
      ...
      if (f = a.f ? g : f)
        try {
          ...
          b = n, a.f = true, yi(a) || (c = true);
        }
    }
    a.c = b;
    d && (h = q(a.v, a, true), d = q(a.v, a, false), b instanceof pi ? (xi(b, h, d), b.A = true) : b.then(h, d));
  ...
  function Bi(a) {
    ...
    e.onload = e.onreadystatechange = function() {
      e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Ci(e, b.wd || false, h), si(g), ti(g, true, null));
    };
    e.onerror = function() {
      Ci(e, true, h);
  ...
  var Dj = { endpoint: "setAccountInfo", B: Aj, Z: "email", C: true }, Cj = { endpoint: "resetPassword", B: Aj, F: function(a) {
    var b = a.requestType;
    if (!b || !a.email && "EMAIL_SIGNIN" != b && "VERIFY_AND_CHANGE_EMAIL" != b)
      throw new t("internal-error");
  }, C: true }, Ej = { endpoint: "signupNewUser", B: function(a) {
    Zi(a);
    if (!a.password)
      throw new t("weak-password");
  }, F: P, U: true, C: true }, bj = { endpoint: "createAuthUri", C: true }, Fj = { endpoint: "deleteAccount", M: ["idToken"] }, sj = { endpoint: "setAccountInfo", M: ["idToken", "deleteProvider"], B: function(a) {
    if (!Array.isArray(a.deleteProvider))
      throw new t("internal-error");
  } }, $g = { endpoint: "emailLinkSignin", M: ["email", "oobCode"], B: Zi, F: P, U: true, C: true }, bh = { endpoint: "emailLinkSignin", M: ["idToken", "email", "oobCode"], B: Zi, F: P, U: true }, Gj = { endpoint: "accounts/mfaEnrollment:finalize", M: ["idToken", "phoneVerificationInfo"], B: pj, F: P, C: true, Na: true }, Hj = { endpoint: "accounts/mfaSignIn:finalize", M: ["mfaPendingCredential", "phoneVerificationInfo"], B: pj, F: P, C: true, Na: true }, Ij = { endpoint: "getAccountInfo" }, jj = { endpoint: "getOobConfirmationCode", M: ["requestType"], B: function(a) {
    if ("EMAIL_SIGNIN" != a.requestType)
      throw new t("internal-error");
    Zi(a);
  }, Z: "email", C: true }, kj = { endpoint: "getOobConfirmationCode", M: ["idToken", "requestType"], B: function(a) {
    if ("VERIFY_EMAIL" != a.requestType)
      throw new t("internal-error");
  }, Z: "email", C: true }, lj = { endpoint: "getOobConfirmationCode", M: ["idToken", "newEmail", "requestType"], B: function(a) {
    if ("VERIFY_AND_CHANGE_EMAIL" != a.requestType)
      throw new t("internal-error");
  }, Z: "email", C: true }, ij = { endpoint: "getOobConfirmationCode", M: ["requestType"], B: function(a) {
    if ("PASSWORD_RESET" != a.requestType)
      throw new t("internal-error");
    Zi(a);
  }, Z: "email", C: true }, dj = { kb: true, endpoint: "getProjectConfig", Tb: "GET" }, Jj = { kb: true, endpoint: "getRecaptchaParam", Tb: "GET", F: function(a) {
    if (!a.recaptchaSiteKey)
      throw new t("internal-error");
  } }, Bj = { endpoint: "resetPassword", B: Aj, Z: "email", C: true }, mj = { endpoint: "sendVerificationCode", M: ["phoneNumber", "recaptchaToken"], Z: "sessionInfo", C: true }, gj = { endpoint: "setAccountInfo", M: ["idToken"], B: $i, U: true }, ch = {
    ...
    F: P,
    U: true
  }, fj = { endpoint: "signupNewUser", F: P, U: true, C: true }, oj = { endpoint: "accounts/mfaEnrollment:start", M: ["idToken", "phoneEnrollmentInfo"], B: function(a) {
    ...
    C: true,
    Na: true
  }, xj = { endpoint: "verifyAssertion", B: tj, Xa: uj, F: vj, U: true, C: true }, zj = { endpoint: "verifyAssertion", B: tj, Xa: uj, F: function(a) {
    if (a.errorMessage && "USER_NOT_FOUND" == a.errorMessage)
      throw new t("user-not-found");
    if (a.errorMessage)
      throw wj(a.errorMessage);
    P(a);
  }, U: true, C: true }, yj = { endpoint: "verifyAssertion", B: function(a) {
    tj(a);
    if (!a.idToken)
      throw new t("internal-error");
  }, Xa: uj, F: vj, U: true }, Kj = { endpoint: "verifyCustomToken", B: function(a) {
    if (!a.token)
      throw new t("invalid-custom-token");
  }, F: P, U: true, C: true }, ah = { endpoint: "verifyPassword", B: function(a) {
    Zi(a);
    if (!a.password)
      throw new t("wrong-password");
  }, F: P, U: true, C: true }, nj = { endpoint: "verifyPhoneNumber", B: ej, F: P, C: true }, ih = {
  ...
  }, jh = { Gb: { USER_NOT_FOUND: "user-not-found" }, endpoint: "verifyPhoneNumber", B: ej, F: P, C: true }, Lj = { endpoint: "accounts/mfaEnrollment:withdraw", M: ["idToken", "mfaEnrollmentId"], F: function(a) {
  ...
  function O(a, b, c) {
    ...
    return E(c).then(b.B).then(function() {
      ...
      return d ? Yi(a, a.h, b.endpoint, e, c, b.Gb, b.kb || false) : Yi(a, a.i, b.endpoint, e, c, b.Gb, b.kb || false);
    }).then(function(g) {
      f = g;
  ...
  Wj.prototype.toString = function() {
    ...
    if (this.a.isOAuthProvider) {
      var b = this.a;
      try {
        var c = index_esm_default.app(this.c).auth().ka();
      } catch (h) {
        c = null;
      }
      b.nb = c;
    ...
    return cj(a).then(function(c) {
      a: {
        ...
        for (var f = 0; f < c.length; f++) {
          ...
          var h = d;
          var n = e;
          0 == g.indexOf("chrome-extension://") ? h = be(g).a == h && "chrome-extension" == n : "http" != n && "https" != n ? h = false : Ce.test(g) ? h = h == g : (g = g.split(".").join("\\."), h = new RegExp("^(.+\\." + g + "|" + g + ")$", "i").test(h));
          if (h) {
            c = true;
            break a;
          }
  ...
  function ak(a) {
    ...
    a.v = Ee().then(function() {
      if (!a.u) {
        var b = a.c, c = a.h, d = Xj(a.b), e = new Vj(a.s, a.g, a.b, a.f);
        e.f = b;
        e.b = c;
        e.c = Za(d || []);
        a.u = e.toString();
  ...
  function zk(a, b) {
    return a.g && a.i && df() === a.i ? mk(a.g, "keyChanged", { key: b }, a.s).then(function() {
    }).o(function() {
    }) : E();
  }
  k.get = function(a) {
  ...
  k.set = function(a, b, c) {
    var d = Xk(a, c), e = this, f = Wk(this, a.D);
  ...
  function $k(a) {
    ...
    a.c = setInterval(function() {
      for (var b in a.a) {
        ...
        c != d && (a.b[b] = c, c = new bd({ type: "storage", key: b, target: window, oldValue: d, newValue: c, a: true }), a.Xb(c));
      }
    }, 1e3);
  }
  function al(a) {
  ...
  k.Mb = function(a, b, c, d) {
    ...
    return this.c = E().then(function() {
      ...
      return new D(function(v, B) {
        ...
        f.addEventListener("resume", n, false);
      ...
      n && f.removeEventListener("resume", n, false);
  ...
  function Al(a) {
    ...
    var c = new sh("unknown", null, null, null, new t("no-auth-event")), d = false, e = Ed(500).then(function() {
  ...
  Gl.prototype.s = function(a) {
    ...
    if (a && a.getUid() && this.h.hasOwnProperty(a.getUid()))
      return false;
    for (var b = false, c = 0; c < this.i.length; c++) {
      var d = this.i[c];
      if (d.Eb(a.c, a.b)) {
        if (b = this.c[a.c])
          b.i(a, d), a && (a.f || a.b) && (this.h[a.getUid()] = true, this.u = va());
        b = true;
        break;
      }
    }
  ...
  function $l(a) {
    a.g && !a.h && Yl(a, false, null, null);
  }
  function Zl(a, b, c) {
    c = c.Fa(b.c, b.b);
    var d = b.g, e = b.f, f = b.h, g = b.S(), h = !!b.c.match(/Redirect$/);
  ...
  function Mm(a, b) {
    a.X = b;
    Ri(a.a, index_esm_default.SDK_VERSION ? Oe(index_esm_default.SDK_VERSION, a.X) : null);
  }
  ...
  function dn(a, b) {
    return O(a.a, Ij, { idToken: b }).then(q(a.Jc, a));
  }
  k.Jc = function(a) {
    a = a.users;
    if (!a || !a.length)
    ...
    this.dispatchEvent(new sm("userReloaded", { gd: a }));
  };
  function en(a) {
  ...
  k.Eb = function(a, b) {
    return "linkViaPopup" == a && (this.i || null) == b && this.g || "reauthViaPopup" == a && (this.i || null) == b && this.g || "linkViaRedirect" == a && (this.ga || null) == b || "reauthViaRedirect" == a && (this.ga || null) == b ? true : false;
  };
  ...
  function En(a) {
    ...
    this.u = [];
    this.P = [];
    this.ac = index_esm_default.INTERNAL.createSubscribe(q(this.yc, this));
    this.X = void 0;
    this.bc = index_esm_default.INTERNAL.createSubscribe(q(this.zc, this));
    Fn(this, null);
  ...
  k.Fc = function(a) {
    this.N.push(a);
    Ri(this.a, index_esm_default.SDK_VERSION ? Oe(index_esm_default.SDK_VERSION, this.N) : null);
  ...
  k.Wc = function(a) {
    ...
    (!Te() || Ie()) && S(this).options.authDomain && a.isOAuthProvider && (e = ek(S(this).options.authDomain, S(this).options.apiKey, S(this).name, "signInViaPopup", a, null, d, index_esm_default.SDK_VERSION || null, null, null, this.S(), this.f));
  ...
  function ko(a, b, c, d, e, f, g) {
    ...
    if (!kc(b) || !this.h && kc(b).hasChildNodes())
  ...
  function W(a, b) {
    return { name: a || "", J: "a valid object", optional: !!b, K: m };
  }
  function xo(a, b) {
  ...
  Y(En.prototype, {
    ...
    Gc: { name: "onAuthStateChanged", j: [X(W(), xo(), "nextOrObserver"), xo("opt_error", true), xo("opt_completed", true)] },
    Hc: {
      name: "onIdTokenChanged",
      j: [X(W(), xo(), "nextOrObserver"), xo("opt_error", true), xo("opt_completed", true)]
    },
    ub: { name: "sendPasswordResetEmail", j: [V("email"), X(W("opt_actionCodeSettings", true), yo(null, true), "opt_actionCodeSettings", true)] },
    vb: { name: "sendSignInLinkToEmail", j: [V("email"), W("actionCodeSettings")] },
    wb: { name: "setPersistence", j: [V("persistence")] },
    Rc: { name: "signInAndRetrieveDataWithCredential", j: [Co()] },
    yb: { name: "signInAnonymously", j: [] },
    Za: { name: "signInWithCredential", j: [Co()] },
    ...
    Vc: { name: "signInWithPhoneNumber", j: [V("phoneNumber"), Ho()] },
    Wc: { name: "signInWithPopup", j: [Eo()] },
    Xc: { name: "signInWithRedirect", j: [Eo()] },
    ...
    fd: { name: "useEmulator", j: [V("url"), W("options", true)] },
  ...
  Y(Im.prototype, {
    ...
    nc: { name: "getIdTokenResult", j: [wo("opt_forceRefresh", true)] },
    I: { name: "getIdToken", j: [wo("opt_forceRefresh", true)] },
    Bc: { name: "linkAndRetrieveDataWithCredential", j: [Co()] },
    pb: { name: "linkWithCredential", j: [Co()] },
    Cc: { name: "linkWithPhoneNumber", j: [V("phoneNumber"), Ho()] },
    Dc: { name: "linkWithPopup", j: [Eo()] },
    Ec: { name: "linkWithRedirect", j: [Eo()] },
    Kc: { name: "reauthenticateAndRetrieveDataWithCredential", j: [Co()] },
    sb: { name: "reauthenticateWithCredential", j: [Co()] },
    Lc: {
      name: "reauthenticateWithPhoneNumber",
      j: [V("phoneNumber"), Ho()]
    },
    Mc: { name: "reauthenticateWithPopup", j: [Eo()] },
    Nc: { name: "reauthenticateWithRedirect", j: [Eo()] },
    reload: { name: "reload", j: [] },
    tb: { name: "sendEmailVerification", j: [X(W("opt_actionCodeSettings", true), yo(null, true), "opt_actionCodeSettings", true)] },
    ...
    dd: { name: "updatePhoneNumber", j: [Co("phone")] },
    Cb: { name: "updateProfile", j: [W("profile")] },
    Db: { name: "verifyBeforeUpdateEmail", j: [V("email"), X(W("opt_actionCodeSettings", true), yo(null, true), "opt_actionCodeSettings", true)] }
  });
  ...
  Y(lh.prototype, { eb: { name: "verifyPhoneNumber", j: [X(V(), function(a, b) {
    return { name: a || "phoneInfoOptions", J: "valid phone info options", optional: !!b, K: function(c) {
      return c ? c.session && c.phoneNumber ? Fo(c.session, zg) && "string" === typeof c.phoneNumber : c.session && c.multiFactorHint ? Fo(c.session, Ag) && Go(c.multiFactorHint) : c.session && c.multiFactorUid ? Fo(c.session, Ag) && "string" === typeof c.multiFactorUid : c.phoneNumber ? "string" === typeof c.phoneNumber : false : false;
    } };
  }(), "phoneInfoOptions"), Ho()] } });
  ...
  Y(tm.prototype, { Qb: { name: "getSession", j: [] }, ec: { name: "enroll", j: [Do(), V("displayName", true)] }, ad: { name: "unenroll", j: [X({ name: "multiFactorInfo", J: "a valid multiFactorInfo", optional: false, K: Go }, V(), "multiFactorInfoIdentifier")] } });
  ...
  (function() {
    if ("undefined" !== typeof index_esm_default && index_esm_default.INTERNAL && index_esm_default.INTERNAL.registerComponent) {
      ...
      index_esm_default.registerVersion("@firebase/auth", "0.16.1");
