    ...
    <div :class="isDarkMode ? 'dark' : ''">
        <div class="mb-6 bg-background dark:bg-backgroundDark flex flex-row  min-h-screen items-center justify-center">
            <div class="h-auto  sm:mt-32 lg:mt-36 mt-28 flex flex-row w-98 lg:w-202 rounded-md overflow-hidden shadow-md ">
                ...
                <div class="flex-grow bg-background dark:bg-secondary-800 px-10 pb-10">
                    ...
                    <div class="flex justify-center">
                        ...
                        <ps-label class="mt-6 mb-6 text-2xl font-senibold justify-center">{{ $t('core__login') }}</ps-label>
                        <!-- <ps-label class="mt-1 mb-6 text-base font-light" textColor="text-secondary-600 dark:text-white">{{
                            $t('login_to_your_acc') }}</ps-label> -->
                    </div>

                    <form @submit.prevent="submit">
                        <div class="mb-4">
                            <ps-label class="mb-2 text-sm" textColor="text-secondary-800 dark:text-feSecondary-200">{{ $t('core__be_email_username') }}</ps-label>
                            <ps-input ref="email" type="text" v-model:value="form.email"
                                ...
                                :placeholder="$t('core__be_email_username_placeholder')" autofocus />
                            <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ errors.email
                            }}</ps-label-caption>
                        </div>
                        <div class="mb-4">
                            <ps-label class="mb-2">{{ $t('core__be_password') }}</ps-label>
                            <ps-input-with-right-icon v-model:value="form.password" ref="password"
                                ...
                                theme="bg-white dark:bg-secondary-800" :type="(isHide ? 'password' : 'text')"
                                defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focus:border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400"
                                ...
                                <template #icon>
                                    <ps-icon viewBox="0 0 24 24" @click="isHide = !isHide" class="cursor-pointer"
                                        theme="text-secondary-800 dark:text-secondary-300"
                                        :name="isHide ? 'eyeOff' : 'eye-on'" />
                                </template>
                            </ps-input-with-right-icon>
                            <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ errors.password
                            }}</ps-label-caption>
                        </div>

                        <div class="flex justify-between mb-4">
                            <ps-checkbox-value name="remember" v-model:checked="form.remember" color="focus:ring-2 focus:ring-fePrimary-300 hover:bg-fePrimary-500 dark:hover:bg-fePrimary-500 checked:bg-fePrimary-500 dark:checked:bg-fePrimary-500 text-fePrimary-500 dark:text-fePrimary-500"
                        ...
                        <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ errors.user_is_bannded
                        }}</ps-label-caption>
                        <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ errors.user_ban
                            }}</ps-label-caption>
                        <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ errors.user_status
                        }}</ps-label-caption>

                    </form>
                    <div class=" flex flex-row justify-center my-8">
                        <ps-label class="me-1" textColor="text-secondary-800 dark:text-secondary-500">
                            {{ $t('donot_have_acc') }}
                        </ps-label>
                    ...
                    <div class="block">
                        ...
                        <div class="flex flex-row justify-center mb-6 ">
                            <span
                                class="w-full h-3 border border-s-0 border-e-0 border-t-0 border-secondary-200 dark:border-secondaryDark-grey" />
                    ...
                    <div class='flex flex-row items-start justify-start mb-6'>
                        <ps-checkbox-value title="" v-model:value="agreePrivacyPolicy" color="focus:ring-2 focus:ring-fePrimary-300 hover:bg-fePrimary-500 dark:hover:bg-fePrimary-500 checked:bg-fePrimary-500 dark:checked:bg-fePrimary-500 text-fePrimary-500 dark:text-fePrimary-500"
                            textColor="text-fePrimary-500 dark:text-fePrimary-500"
                    ...
                    <div class="flex flex-row  justify-center  space-x-3 rtl:space-x-reverse">
                        ...
                        <!-- phone -->
                        <div @click="phoneiconclicked" v-if="appInfoStore?.appInfo?.data?.mobileSetting.show_phone_login == 1"
                            class="cursor-pointer rounded w-10 h-10 flex bg-backgroundDark justify-center items-center">

                            <svg class="flex flex-wrap items-center justify-center   rtl:space-x-reverse space-x-2 space-y-2  text-white dark:text-primaryDark-white"
                                width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="40" height="40" rx="4" fill="#38C141" />
                                <mask id="mask0_3456_4766" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="8" y="8"
                                    width="24" height="24">
                        ...
                        <!-- facebook -->
                        <div @click="facebookiconclicked" v-if="appInfoStore?.appInfo?.data?.mobileSetting.show_facebook_login == 1"
                            class="cursor-pointer rounded w-10 h-10 flex bg-white justify-center border items-center">
                        ...
                        <div @click="googleiconclicked" v-if="appInfoStore?.appInfo?.data?.mobileSetting.show_google_login == 1"
                            class="cursor-pointer rounded w-10 h-10 flex bg-white justify-center border items-center">
                            <svg class="flex flex-wrap items-center justify-center   rtl:space-x-reverse space-x-2 space-y-2  text-white dark:text-primaryDark-white"
                        ...
                        <!-- apple -->
                        <!-- <div @click="appleiconclicked" class="cursor-pointer rounded w-10 h-10 flex bg-backgroundDark justify-center items-center">

                            <ps-icon textColor=""
                                class=" flex flex-wrap items-center justify-center   rtl:space-x-reverse space-x-2 space-y-2  text-white dark:text-primaryDark-white"
