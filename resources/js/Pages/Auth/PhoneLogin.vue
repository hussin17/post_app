<template>
    ...
    <div :class="isDarkMode ? 'dark' : ''">
        ...
        <div class="mb-6 bg-background dark:bg-backgroundDark flex flex-row   mt-28  min-h-screen items-center justify-center">
                    ...
                    <form @submit.prevent="clicked">
                        ...
                        <img v-else :src="$page.props.uploadUrl + '/no_logo.png'" width="200" height="100"
                            ...
                            <ps-label-title class="text-center m-auto pb-8 pt-2 mt-10"
                                textColor="text-secondary-600 dark:text-white">{{
                                    $t('phone_login__phone_login') }}</ps-label-title>
                            <ps-label class="mt-4  "> {{ $t("phone_login__display_name") }} : </ps-label>
                            <ps-input class="mt-2 placeholder-secondary-800 dark:placeholder-secondary-500" type="text" v-bind:placeholder="$t('phone_login__display_name_placeholder')"
                            ...
                            <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ displayName
                            }}</ps-label-caption>
                            <!-- Username -->
                        ...
                        <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ usernameError
                        }}</ps-label-caption> -->
                            ...
                            <div class="flex">
                                ...
                                <ps-dropdown align="left" class=" mt-2 w-20">
                                    <template #select>
                                        <ps-dropdown-select border="border border-secondary-200 dark:border-feSecondary-400 focus:outline-none focus:ring-1 focus:ring-primary-500" placeholder="phone" :showCenter="true"
                                    ...
                                    <template #list>
                                        <div class="rounded-md shadow-xs w-16 bg-background dark:bg-backgroundDark">
                                            <div class="pt-2 z-20">
                                ...
                                theme="text-feSecondary-500 dark:bg-secondary-800"
                                defaultBorder="border border-secondary-200 dark:border-feSecondary-400 focus:outline-none focus:ring-1 focus:ring-primary-500"
                                    v-bind:placeholder="$t('phone_login__phone_number_placeholderv2')"
                            ...
                            <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ phoneError
                            }}</ps-label-caption>

                            <ps-input v-if="code_data_ready" class="mt-4 " type="text"
                                v-bind:placeholder="$t('phone_login__code')" v-model:value="code"></ps-input>
                            <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ codeError
                            }}</ps-label-caption>
                            ...
                            <div class="flex flex-auto justify-center mt-4 mb-10">
                                ...
                                <ps-button colors="bg-white dark:bg-secondary-800 dark:text-white " border="border" class="mt-6  w-full" @click="loginClicked" :disabled="false" >
