...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        ...
        $webPushKey = FrontendSetting::first()->firebase_web_push_key_pair;

        $firebaseConfigStr = FrontendSetting::first()->firebase_config;
        if(FrontendSetting::first()->firebase_config == null || FrontendSetting::first()->firebase_config == ''){
