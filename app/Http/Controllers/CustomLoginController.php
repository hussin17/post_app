...
class CustomLoginController extends AuthenticatedSessionController
{
    ...
    protected $phoneVerify, $facebookVerify, $userApiController, $publish, $normalUserRoleId, $googleVerify, $badRequestStatusCode, $userService, $imageService, $successStatus, $okStatusCode, $userExisted, $userNotExisted, $errorStatus, $userNotExistedAndNormalLogin;
