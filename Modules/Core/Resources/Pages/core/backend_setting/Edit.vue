                    ...
                    <div >
                        <div class="grid grid-cols-1 md:grid-cols-2  gap-2 mt-4">
                            <div>
                                ...
                                <div v-if="title == settingColumn[3].label">
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <div v-if="backend_setting.backend_logo[0]" class="flex items-end pt-4">
                                            ...
                                            <ps-button type="button" @click="replaceImageClicked(backend_setting.backend_logo[0].id, true,'backend_logo')" rounded="rounded-full"
                                                shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black" border="border border-1 dark:border-secondary-700 border-secondary-300" padding="p-1.5" hover="" focus="">
                                                <ps-icon name="pencil-btn" w="21" h="21" />
                                            </ps-button>
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <div v-if="backend_setting.fav_icon[0]" class="flex items-end pt-4">
                                            ...
                                            <ps-button type="button" @click="replaceImageClicked(backend_setting.fav_icon[0].id, false,'fav_icon')" rounded="rounded-full"
                                                shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black" border="border border-1 dark:border-secondary-700 border-secondary-300" padding="p-1.5" hover="" focus="">
                                                <ps-icon name="pencil-btn" w="21" h="21" />
                                            </ps-button>
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <div v-if="backend_setting.backend_meta_image[0]" class="flex items-end pt-4">
                                            <img
                                            v-lazy=" { src: $page.props.uploadUrl + '/' + backend_setting.backend_meta_image[0].img_path, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                             width="200" height="200"
                                                class="w-48 h-48" alt="backend_meta_image" />
                                            <ps-button type="button" @click="replaceImageClicked(backend_setting.backend_meta_image[0].id, false,'backend_meta_image')" rounded="rounded-full"
                                                shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black" border="border border-1 dark:border-secondary-700 border-secondary-300" padding="p-1.5" hover="" focus="">
                                                <ps-icon name="pencil-btn" w="21" h="21" />
                                            </ps-button>
                                ...
                                <div v-if="title == settingColumn[8].label">
                                     ...
                                     <div class="px-4 py-3" v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'is_watermask' && coreField.enable === 1 && coreField.is_delete === 0)" :key="index">
                                        ...
                                        <div class="px-4 py-3">
                                            ...
                                            <ps-label v-if="!backend_setting.water_mask_background[0]" textColor="text-secondary-400 text-xs"> {{ $t('core__be_recommended_size_16_16') }}
                                            </ps-label>
                                            <div v-if="backend_setting.water_mask_background[0]" class="flex items-end pt-4">
                                                <img
                                                v-lazy=" { src: $page.props.uploadUrl + '/' + backend_setting.water_mask_background[0].img_path, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                                width="200" height="200"
                                                    class="w-48 h-48" alt="water_mask_background" />
                                                <ps-button type="button" @click="replaceImageClicked(backend_setting.water_mask_background[0].id, false,'water_mask_background','preview')" rounded="rounded-full"
                                                    shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                    colors="bg-white text-primary-500 dark:bg-secondaryDark-black" border="border border-1 dark:border-secondary-700 border-secondary-300" padding="p-1.5" hover="" focus="">
                                                    <ps-icon name="pencil-btn" w="21" h="21" />
                                                </ps-button>
                                            ...
                                            <ps-image-upload v-else class="w-72" uploadType="icon" v-model:imageFile="form.water_mask_background" />
                                        ...
                                        <ps-label class="py-3 text-xl ">{{$t('water_mask_preview')}}</ps-label>
                                            <div class="container mx-auto grid-cols-4 lg:space-y-0  lg:gap-2 lg:grid  lg:grid-cols-4" v-if="reRenderImage">
                                                ...
                                                <div v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]" class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center ">
                                                    <img class="object-cointain" v-lazy=" { src: $page.props.uploadUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime , loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                                ...
                                                <div v-else class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center ">
                                                ...
                                                <div  v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]" class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center content-end">
                                                    <img class="object-cointain" v-lazy=" { src: $page.props.thumb1xUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                                    alt="water_mask_background" width="80" />
                                                        <ps-label class="text-base grid place-items-center">{{ $t('1x_thumb_preview') }} </ps-label>
                                                </div>
                                                <div v-else class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center ">
                                                ...
                                                <div  v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]" class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center content-end">
                                                    <img class="object-cointain" v-lazy=" { src: $page.props.thumb2xUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                                    alt="water_mask_background" width="100"/>
                                                    <ps-label class="text-base grid place-items-center">{{ $t('2x_thumb_preview') }} </ps-label>
                                                </div>
                                                <div v-else class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center ">
                                                ...
                                                <div  v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]" class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center content-end ">
                                                    <img class="object-cointain" v-lazy=" { src: $page.props.thumb3xUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                                    alt="water_mask_background" width="110" />
                                                    <ps-label class="text-base grid place-items-center">{{ $t('3x_thumb_preview') }} </ps-label>
                                                </div>
                                                <div v-else class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center ">
                                ...
                                <div v-if="title == settingColumn[2].label" class="pt-6 border-t border-secondary-800 dark:border-secondary-100">
...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ['errors', 'backend_setting', 'commonColor','status', 'coreFieldFilterSettings','can','validation','paddingList'],
    setup(props) {
