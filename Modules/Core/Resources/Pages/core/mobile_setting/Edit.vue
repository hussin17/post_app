<template>
    ...
    <ps-layout>
        ...
        <ps-card class="w-full h-auto">
            <div class="rounded-lg bg-background dark:bg-secondaryDark-black ">
                <!-- card header start -->
                ...
                <form @submit.prevent="handleSubmit(this.mobile_setting.id)">
                    <div class="grid grid-cols-1 gap-2 mt-4 md:grid-cols-2">
                        <div>
                            <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[0].label">
                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_google_play_url') }}</ps-label>
                                    <ps-input type="text" v-model:value="form.google_playstore_url"
                                        :placeholder="$t('core_mb_setting_google_play_url')" />
                                </div>

                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_app_store_url') }}</ps-label>
                                    <ps-input type="text" v-model:value="form.apple_appstore_url"
                                        :placeholder="$t('core_mb_setting_app_store_url')" />
                                </div>

                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_ios_store_id') }}</ps-label>
                                    <ps-input type="text" v-model:value="form.ios_appstore_id"
                                        :placeholder="$t('core_mb_setting_ios_store_id')" />
                                </div>
                            </div>
                            <!-- End Mobile setting-->
                            <!-- <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[1].label">
                                <div>
                            ...
                            <!-- Start Image setting -->
                            <!-- <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[2].label">
                                <div>
                            ...
                            <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[1].label">
                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_item_detail_view_count_for_ads')
                                    }}</ps-label>
                                    <ps-input type="text" v-model:value="form.item_detail_view_count_for_ads"
                                        :placeholder="$t('core_mb_setting_item_detail_view_count_for_ads')"
                                        @keypress="onlyNumber" />
                                </div>

                                <div>
                                    <ps-checkbox-value :title="$t('core_mb_setting_AdMob_setting_on')"
                                        v-model:value="form.is_show_admob" />
                                </div>

                                <div>
                                    <ps-checkbox-value :title="$t('core_mb_setting_is_show_admob_inside_item')"
                                        v-model:value="form.is_show_ads_in_item_detail" />
                                </div>

                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_android_admob_banner_ad_unit_id')
                                    }}</ps-label>
                                    <ps-input type="text" v-model:value="form.android_admob_banner_ad_unit_id"
                                        :placeholder="$t('core_mb_setting_android_admob_banner_ad_unit_id')"
                                        @keypress="onlyNumber" />
                                </div>
                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_android_admob_native_unit_id')
                                    }}</ps-label>
                                    <ps-input type="text" v-model:value="form.android_admob_native_unit_id"
                                        :placeholder="$t('core_mb_setting_android_admob_native_unit_id')"
                                        @keypress="onlyNumber" />
                                </div>
                                <div>
                                    <ps-label class="text-base">{{
                                        $t('core_mb_setting_android_admob_interstitial_ad_unit_id') }}</ps-label>
                                    <ps-input type="text" v-model:value="form.andorid_admob_interstitial_ad_unit_id"
                                        :placeholder="$t('core_mb_setting_android_admob_interstitial_ad_unit_id')"
                                        @keypress="onlyNumber" />
                                </div>
                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_ios_admob_banner_ad_unit_id')
                                    }}</ps-label>
                                    <ps-input type="text" v-model:value="form.ios_admob_banner_ad_unit_id"
                                        :placeholder="$t('core_mb_setting_ios_admob_banner_ad_unit_id')"
                                        @keypress="onlyNumber" />
                                </div>
                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_ios_admob_native_unit_id')
                                    }}</ps-label>
                                    <ps-input type="text" v-model:value="form.ios_admob_native_ad_unit_id"
                                        :placeholder="$t('core_mb_setting_ios_admob_native_unit_id')"
                                        @keypress="onlyNumber" />
                                </div>
                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_ios_admob_interstitial_ad_unit_id')
                                    }}</ps-label>
                                    <ps-input type="text" v-model:value="form.ios_admob_interstitial_ad_unit_id"
                                        :placeholder="$t('core_mb_setting_ios_admob_interstitial_ad_unit_id')"
                                        @keypress="onlyNumber" />
                                </div>
                            </div>
                            <!-- End AdMob setting -->
                            <!-- Start Login setting -->
                            <!-- <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[4].label">
                                <div>
                            ...
                            <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[2].label">
                                ...
                                <div>
                                    <ps-checkbox-value :title="$t('core_mb_setting_main_menu_on')"
                                        v-model:value="form.show_main_menu" />
                                    <ps-label-caption textColor="text-secondary-400 mt-1">{{
                                        $t('core_mb_setting_main_menu_on_info') }}</ps-label-caption>
                                </div>
                                ...
                                <div>
                                    <ps-checkbox-value :title="$t('core_mb_setting_featured_items_on')"
                                        v-model:value="form.show_featured_items" />
                                    <ps-label-caption textColor="text-secondary-400 mt-1">{{
                                        $t('core_mb_setting_featured_items_on_info') }}</ps-label-caption>
                                </div>
                            ...
                            <!-- <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[6].label">
                                <div>
                            ...
                            <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[3].label">
                                <div>
                                    <ps-label>{{ $t('core_mb_setting_version_no') }}</ps-label>
                                    <ps-input type="text" v-model:value="form.version_no"
                                        :placeholder="$t('core_mb_setting_version_no')" />
                                </div>

                                <div>
                                    <ps-label>{{ $t('core_mb_setting_version_title') }}</ps-label>
                                    <ps-input type="text" v-model:value="form.version_title"
                                        :placeholder="$t('core_mb_setting_version_title')" />
                                </div>

                                <div>
                                    <ps-label>{{ $t('core_mb_setting_version_message') }}</ps-label>
                                    <ps-textarea rows="4" v-model:value="form.version_message"
                                        :placeholder="$t('core_mb_setting_version_message')"></ps-textarea>
                                </div>

                                <div>
                                    <ps-checkbox-value :title="$t('core_mb_setting_version_force_update')"
                                        v-model:value="form.version_force_update" />
                                </div>

                                <div>
                                    <ps-checkbox-value :title="$t('core_mb_setting_version_need_clear_data')"
                                        v-model:value="form.version_need_clear_data" />
                                </div>
                                        ...
                                        <div v-for="common_color in form.commonColor" :key="common_color.id">
                                            <div class="flex flex-row p-1">
                                                <div class="w-6 h-6 m-1 rounded shadow-sm cursor-pointer">
                                                    <div @click="colorPickerClicked(common_color)"
                                                        class="w-6 h-6 rounded shadow-sm cursor-pointer"
                                                        :style="{ 'background-color': common_color.value }"></div>
                                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div v-for="light_color in form.lightColor" :key="light_color.id">
                                            <div class="flex flex-row p-1">
                                                <div class="w-6 h-6 m-1 rounded shadow-sm cursor-pointer">
                                                    <div @click="colorPickerClicked(light_color)"
                                                        class="w-6 h-6 rounded shadow-sm cursor-pointer"
                                                        :style="{ 'background-color': light_color.value }"></div>
                                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div v-for="dark_color in form.darkColor" :key="dark_color.id">
                                            <div class="flex flex-row p-1">
                                                <div class="w-6 h-6 m-1 rounded shadow-sm cursor-pointer">
                                                    <div @click="colorPickerClicked(dark_color)"
                                                        class="w-6 h-6 rounded shadow-sm cursor-pointer"
                                                        :style="{ 'background-color': dark_color.value }"></div>
                                                </div>
                            ...
                            <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[5].label">
                                ...
                                <div class="">
                                    ...
                                    <ps-dropdown align="left" class='w-full mt-1 lg:mt-2'>
                                        <template #select>
                                            <ps-dropdown-select
                                                :selectedValue="(form.data_config_data_source_type == '') ? '' : form.data_config_data_source_type"
                                                placeholder="Select Type" />
                                        </template>
                                        <template #list>
                                            <div class="w-full rounded-md shadow-xs">
                                                <div class="z-30 pt-2 ">
                                                    <!-- <div class="flex items-center px-2 py-4 cursor-pointer hover:bg-primary-000 dark:hover:bg-primary-900">
                                                        <ps-label class="text-secondary-200">{{$t('core_sys_select_ad_post_type')}}</ps-label>
                                                    </div> -->
                                                    <div @click="form.data_config_data_source_type = 'FULL_CACHE'"
                                                        class="flex items-center px-2 py-4 cursor-pointer hover:bg-primary-000 dark:hover:bg-primary-900">
                                                        <ps-label class="ms-2">FULL_CACHE</ps-label>
                                                    </div>
                                                    <div @click="form.data_config_data_source_type = 'SERVER_DIRECT'"
                                                        class="flex items-center px-2 py-4 cursor-pointer hover:bg-primary-000 dark:hover:bg-primary-900">
                                ...
                                <div>
                                    ...
                                    <ps-input type="text" v-model:value="form.data_config_day"
                                        :placeholder="$t('core_mb_setting_data_config_day')" @keypress="onlyNumber" />
                                </div>
                            </div>
                            ...
                            <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[6].label">
                                <div>
                                    <ps-checkbox-value :title="$t('core_mb_setting_is_slider_autoplay')"
                                        v-model:value="form.is_slider_auto_play" />
                                </div>
                                <div>
                                    <ps-label class="text-base">{{ $t('core_mb_setting_slider_autoplay') }}
                                        (Milliseconds)</ps-label>
                                    <ps-input type="text" v-model:value="form.auto_play_interval"
                                        :placeholder="$t('core_mb_setting_slider_autoplay')" @keypress="onlyNumber" />
                                </div>
                            </div>
                            <!-- End Slider setting -->
                            <!-- <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[11].label">
                                <div>
                            ...
                            <!-- Start Other setting -->
                            <div class="grid gap-6 grid-rows ms-4 me-18" v-if="title == settingColumn[7].label">
                                        ...
                                        <ps-tooltip tooltiptext="absolute z-50 bottom-full ms-0.5">
                                            ...
                                            <template #tooltips>
                                                For more details: <a target="_blank"
                                                    href="https://doc.clickup.com/24312566/p/h/q5yqp-79305/1afb3b05d1416bd"
                                                    class="underline">Refer to this doc</a>
                                            </template>
                                        </ps-tooltip>
                                    </div>

                                    <ps-input type="text" v-model:value="form.fb_key"
                                        :placeholder="$t('core_mb_setting_facebook_key')" />
                                </div>
                                ...
                                <div>
                                    <div class="flex items-center">
                                        ...
                                        <ps-tooltip tooltiptext="absolute z-50 bottom-full ms-0.5">
                                            ...
                                            <template #tooltips>
                                                For more details: <a target="_blank"
                                                    href="https://doc.clickup.com/24312566/p/h/q5yqp-80705/bb50824fae048c2"
                                                    class="underline">Refer to this doc</a>
                                            </template>
                                        </ps-tooltip>
                                    </div>
                                    <ps-input type="text" v-model:value="form.date_format"
                                        :placeholder="$t('core_mb_setting_date_format')" />
                                    <ps-label-caption textColor="text-secondary-400 mt-1">{{
                                        $t('core_mb_setting_date_format_ex') }}dd for the day, MM for the month, yyyy for
                                        the year, hh for the hour, mm for the minute, ss for the second (e.g. dd-MM-yyyy
                                        hh:mm:ss)</ps-label-caption>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <ps-checkbox-value :title="$t('core_mb_setting_use_google_map_on')"
                                        v-model:value="form.is_use_google_map" />
                                    <ps-tooltip tooltiptext="absolute z-50 bottom-full mb-2 -ms-2.5">
                                        <template #content>
                                            <ps-icon name="info" w="20" h="20"
                                                class="transition-all duration-300 -ms-1 text-primary-500" />
                                        </template>
                                        <template #tooltips>
                                            For more details: <a target="_blank"
                                                href="https://doc.clickup.com/24312566/p/h/q5yqp-81685/a727d26cbbd9977"
                                                class="underline">Refer to this doc</a>
                                        </template>
                                    </ps-tooltip>
                                </div>
                                ...
                                <!-- <div>
                                    <div class="flex items-center">
                                        ...
                                        <ps-tooltip tooltiptext="absolute z-50 bottom-full mb-2 -ms-2.5">
                                            <template #content>
                                                <ps-icon name="info" w="20" h="20" class="transition-all duration-300 -ms-1 text-primary-500"/>
                                            </template>
                                            <template #tooltips>
                                ...
                                <div class="flex items-center">
                                    <ps-checkbox-value :title="$t('core_mb_setting_is_language_config')"
                                    ...
                                    <ps-tooltip tooltiptext="absolute z-50 bottom-full mb-2 -ms-2.5">
                                        ...
                                        <template #tooltips>
                                            For more details: <a target="_blank"
                                                href="https://doc.clickup.com/24312566/p/h/q5yqp-84745/0d66cec92b46197"
                                                class="underline">Refer to this doc</a>
                                        </template>
                                    </ps-tooltip>
                                </div>
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <ps-label class="text-base">{{ $t('core_mb_setting_item_loading_cell_count')
                                        }}</ps-label>
                                        <ps-tooltip tooltiptext="absolute z-50 bottom-full ms-0.5">
                                            <template #content>
                                                <ps-icon name="info" w="20" h="20"
                                            ...
                                            <template #tooltips>
                                                For more details: <a target="_blank"
                                                    href="https://doc.clickup.com/24312566/p/h/q5yqp-85385/a92d0c602507852"
                                                    class="underline">Refer to this doc</a>
                                            </template>
                                        </ps-tooltip>
                                    </div>
                                    <ps-input type="text" v-model:value="form.loading_shimmer_item_count"
                                        :placeholder="$t('core_mb_setting_item_loading_cell_count')"
                                        @keypress="onlyNumber" />
                                </div>
                            ...
                            <div class="flex flex-row justify-end mt-6 mb-2.5">
                                ...
                                <ps-button :disabled="!mobile_setting.authorizations.update"
                                    class="transition-all duration-300 min-w-3xs" padding="px-7 py-2" rounded="rounded"
                                    hover="" focus="">
    ...
    setup(props) {
        ...
        const settingColumn = [
            ...
            },
            {
                ...
                docu: 'https://doc.clickup.com/24312566/p/h/q5yqp-85685/c0b13270c686956'
