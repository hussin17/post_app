...
class FrontendSettingApiResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            'map_key' => (string)BackendSetting::first()->map_key,
            ...
            'google_map' => (string)BackendSetting::first()->is_google_map,
            'open_street_map' => (string)BackendSetting::first()->is_open_street_map,
            ...
            "frontend_logo" => new CoreImageApiResource(isset($this->frontend_logo[0]) && $this->frontend_logo[0] ? $this->frontend_logo[0]: CoreImage::where(CoreImage::id, 0)->get()),
            "frontend_icon" => new CoreImageApiResource(isset($this->frontend_icon[0]) && $this->frontend_icon[0] ? $this->frontend_icon[0]: CoreImage::where(CoreImage::id, 0)->get()),
            "frontend_banner" => new CoreImageApiResource(isset($this->frontend_banner[0]) && $this->frontend_banner[0] ? $this->frontend_banner[0]: CoreImage::where(CoreImage::id, 0)->get()),
       ];
    }
}
