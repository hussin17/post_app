...
class FrontendSettingService extends PsService
{
    ...
    protected $imageService,$show, $hide, $delete, $unDelete, $viewAnyAbility, $createAbility, $editAbility, $deleteAbility, $code, $screenDisplayUiKeyCol, $screenDisplayUiIdCol, $screenDisplayUiIsShowCol, $coreFieldFilterModuleNameCol, $customUiIsDelCol;
    ...
    public function getFrontendSetting($id = null){
        $frontendSetting = FrontendSetting::with(['frontend_logo','frontend_banner','frontend_icon'])
