...
class ImageService extends PsService
{
    ...
    public function applyWatermask($backend_setting, $image, $watermarkImage)
    {
        ...
        $watermark = $watermark->resize($backend_setting->watermask_image_size / 10, $backend_setting->landscape_thumb3x_width / 10, function ($constraint) {
            $constraint->aspectRatio();
        })
    ...
    public function getImages($imgParentId = null, $imgType = null, $limit = null, $offset = null, $notImgTypes = null)
    {
        $images = CoreImage::when($imgParentId, function ($q, $imgParentId) {
            ...
            ->when($imgType, function ($q, $imgType) {
                $q->where($this->coreImageImgTypeCol,'like',"%$imgType%");
            })
