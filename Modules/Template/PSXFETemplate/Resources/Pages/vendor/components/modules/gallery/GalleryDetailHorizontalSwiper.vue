<template>
        ...
        <template #body>
            <div class="w-screem flex flex-col">
                <div class="flex flex-row justify-between"> 
                    <div class="flex-grow" />
                    <font-awesome-icon @click="psmodal.toggle(false)" :icon="['fas', 'times']" class="text-feSecondary-700 dark:text-feSecondaryDark-grey" size="2x" />
                </div>
                <div class=" flex flex-row justify-between">
                    <div class="my-auto" @click="leftArrowClicked">
                        <ps-icon name="leftArrow" class='block sm:hidden stroke-current stroke-0 ' textColor="text-feSecondary-700 dark:text-feSecondaryDark-grey" w="30" h="30" />
                        <ps-icon name="leftArrow" class='hidden sm:block lg:hidden stroke-current stroke-0 ' textColor="text-feSecondary-700 dark:text-feSecondaryDark-grey" w="40" h="40" />
                        <ps-icon name="leftArrow" class='hidden lg:block stroke-current stroke-0 ' textColor="text-feSecondary-700 dark:text-feSecondaryDark-grey" w="50" h="50" />
                    </div>
 ...
 width="300px" height="400px" class="w-full h-112 overflow:hidden object-contain" >
                    ...
                    <div class="my-auto cursor-pointer"  @click="rightArrowClicked">
                        <ps-icon  name="rightArrow" class='block sm:hidden stroke-current stroke-0 ' textColor="text-feSecondary-700 dark:text-feSecondaryDark-grey" w="30" h="30"  />
                        <ps-icon  name="rightArrow" class='hidden sm:block lg:hidden stroke-current stroke-0 ' textColor="text-feSecondary-700 dark:text-feSecondaryDark-grey" w="40" h="40"  />
                        <ps-icon  name="rightArrow" class='hidden lg:block stroke-current stroke-0 ' textColor="text-feSecondary-700 dark:text-feSecondaryDark-grey" w="50" h="50"  />
                    </div>
                </div>
            </div>
        </template>
