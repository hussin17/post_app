        ...
        <template #body>
         ...
         <template #footer>
            <div class=" flex flex-row justify-between">
                <ps-button @click="actionClicked('no')" textSize="text-xxs lg:text-sm" class="py-3 " theme="bg-feSecondary-000 dark:bg-feSecondaryDark-grey text-fePrimary-500 dark:text-fePrimaryDark-white"> {{ $t('profile__cancel')}} </ps-button>  
