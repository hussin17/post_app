<template>
    <div class=" w-full md:w-auto cursor-pointer my-2 ">
        <!-- Pscard -->
        <div class="flex flex-col my-2 bg-fePrimary-50 h-[196px] rounded-md dark:bg-feBackgroundDark" :enabledHover="true">
            <div class="px-4 mt-4">

                <div class="flex justify-between">
                    <rating-view :iconColor="'text-yellow-500 dark:text-yellow-accent'" :size="'md'" :rating="rate ? rate.rating:0" :maxStars="5" :hasCounter="true" />
