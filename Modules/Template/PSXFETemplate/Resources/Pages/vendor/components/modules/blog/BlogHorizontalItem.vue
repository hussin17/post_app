<template>
    <div class="rounded-lg cursor-pointer w-full h-full shadow-sm overflow-hidden bg-feSecondary-000 dark:bg-feSecondary-800" v-on:click="onClick != null ? onClick(blog) : null">
        <div class="h-56">
            <img alt="Placeholder" class="w-full h-full object-cover" width="360px" height="100px"
