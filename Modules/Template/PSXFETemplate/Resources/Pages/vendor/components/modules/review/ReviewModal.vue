       ...
       <ps-modal ref="psmodal" line="hidden" maxWidth="405px" bodyHeight="488px" :isClickOut='false' theme="p-6 rounded-md">
            ...
            <div class=" w-full p-2">
                <div class="w-full flex flex-col">
                    ...
                    <div class="flex justify-between">
                        ...
                        <ps-icon name="close" class="cursor-pointer text-gray-400" @click.prevent="cancel"></ps-icon>
                    </div>

                    <div class="mt-5">
                        <ps-label class="font-semibold text-center text-lg">{{ $t("review_entry__your_experience") }}</ps-label>
                        <rating-selected ref="rating" class="mt-3 flex justify-center" :grade="0" :maxStars="5" :hasCounter="true" colors="text-yellow-500"/>
                    </div>
        ...
        <template #footer>
            <div class="grid grid-cols-4 gap-6">
                ...
                <ps-button @click="cancel()" textSize="text-xxs lg:text-sm" class="col-span-2" colors="bg-white dark:bg-gray-800 dark:text-gray-200 hover:text-white" border="border border-gray-300 dark:border-gray-500"> {{ $t("review_entry__cancel") }} </ps-button>
            </div>
