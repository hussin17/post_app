<template>
    <ps-modal ref="psmodal" theme="p-2 dark:bg-feBackground dark:bg-feSecondary-900 border rounded-xl" maxWidth="408px" :visibleLine="false" :isClickOut='true' class="z-50" >
        <template #title>
            <ps-icon @click="closeModal()" name="close" class="text-sm text-secondary-400 ms-auto my-auto focus:shadow-none hover:text-purple-500 flex justify-end"  />
