    ...
    <div>
        <splide :options="options" :has-track="false">
            ...
            <div class="splide__arrows splide__arrows--ltr">
                <button
                    class="bg-feSecondary-000 dark:bg-feSecondary-800 w-10 h-10 rounded shadow-sm p-2 arrow splide__arrow--prev"
                    type="button"
                ...
                <button
                    class="bg-feSecondary-000 dark:bg-feSecondary-800 w-10 h-10 rounded shadow-sm p-2 arrow splide__arrow--next"
                    type="button"
