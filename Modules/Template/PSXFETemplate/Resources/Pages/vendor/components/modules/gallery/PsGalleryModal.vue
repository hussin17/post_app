<template>
    <ps-modal ref="psmodal" maxWidth="100%" bodyHeight="h-full" line="hidden" :isClickOut='false' theme="rounded-lg bg-transparent dark:bg-transparent" class=' z-20'>
        <template #body>
                    ...
                    <Splide :options="options" :has-track="false">
                        <SplideTrack>
                            <SplideSlide>
                                ...
                                <img v-if="img_type == 'item'" class="w-auto h-full mx-auto rounded-lg" v-lazy=" { src: $page.props.uploadUrl + '/' + active_img_path, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }" />
                            </SplideSlide>
                        ...
                        <div class="splide__arrows splide__arrows--ltr">
                            <button
                                class="bg-feSecondary-000 dark:bg-feSecondary-800 w-10 h-10 rounded shadow-sm p-2 splide__arrow--prev"
                                type="button"
                            ...
                            <button
                                class="bg-feSecondary-000 dark:bg-feSecondary-800 w-10 h-10 rounded shadow-sm p-2 splide__arrow--next"
                                type="button"
