<template>
    <div class="cursor-pointer h-full w-full" v-on:click="onClick != null ? onClick(user) : null">
        <!-- admin Pscard -->
        <ps-card class="flex-col h-full bg-fePrimary-000 dark:bg-fePrimaryDark-black">
            <div class="p-4 bg-fePrimary-000 dark:bg-fePrimaryDark-black rounded-xl lg:rounded-2xl">
