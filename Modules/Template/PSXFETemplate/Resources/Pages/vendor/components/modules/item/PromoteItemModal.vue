                ...
                <div class="">
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex">
                            ...
                            <ps-time-picker class="bg-fePrimary-000 dark:bg-fePrimaryDark-black" v-model:hour="startTimeH"  v-model:min="startTimeM" v-model:ampm="startTimeAmpm"/>
                        </div>
                        <!-- end Ads Start Time -->
   ...
   setup() {
        ...
        async function loadUserData() {
            ...
            if(info.status == PsStatus.SUCCESS) {
                console.log(info.data.psAppSetting);
