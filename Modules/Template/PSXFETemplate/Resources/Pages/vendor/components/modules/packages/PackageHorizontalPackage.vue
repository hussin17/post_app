<template>
    <div :class="'border-feSecondary-400'" class="bg-background dark:bg-feSecondary-800 border-2 rounded-lg shadow-sm px-4 sm:px-4 lg:px-5 xl:px-6 py-4 sm:py-1 md:py-2 lg:py-2">
        <div>
