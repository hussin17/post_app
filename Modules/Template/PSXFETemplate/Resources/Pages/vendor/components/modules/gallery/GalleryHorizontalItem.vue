<template>
    ...
    <div v-if="gallery.ordering <= imageCount" class='w-screen bg-fePrimary-000 dark:bg-fePrimaryDark-black overflow-hidden rounded-xl  h-56 flex flex-row justify-center items-center'  >
