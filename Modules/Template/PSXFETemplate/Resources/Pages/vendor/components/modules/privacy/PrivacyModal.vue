    ...
    <ps-modal ref="psmodal" maxWidth="650px" :isClickOut='false' class="z-50"  theme="p-6 rounded-md w-auto overflow-hidden">
        ...
        <template #footer>
            <div class="flex justify-end">
                ...
                <ps-button @click="userAction(false)" class='ms-4' textSize="text-xxs lg:text-sm" colors="bg-white dark:bg-gray-800 dark:text-gray-200 hover:text-white" border="border border-gray-300 dark:border-gray-500">  {{ $t('privact_modal__reject') }} </ps-button>
            </div>
        </template>
    </ps-modal>
</template>
