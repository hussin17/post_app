       ...
       <ps-modal ref="psmodal"  line="hidden" maxWidth="534px" :isClickOut='false' class='h-full  ' bodyHeight="max-h-72" theme="px-4 py-8 sm:p-8 rounded-lg">
        <template #title>
            ...
            <div class="flex justify-between items-start">
                ...
                <!-- <font-awesome-icon @click="psmodal.toggle(false)" :icon="['fas', 'times']" class="text-feSecondary-500 dark:text-feSecondaryDark-white" size="2x" /> -->
        ...
        <template #footer>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                <ps-button class="" padding="px-8 py-4" rounded="rounded-lg" @click="paymentClicked('PAYPAL')" >{{ $t('promote_item_modal__pay_with_paypal') }}</ps-button>
                <ps-button class="" padding="px-8 py-4" rounded="rounded-lg" @click="paymentClicked('STRIPE')" >{{ $t('promote_item_modal__pay_with_stripe') }}</ps-button>
                <ps-button class="" padding="px-8 py-4" rounded="rounded-lg" @click="paymentClicked('RAZOR')" >{{ $t('promote_item_modal__pay_with_razor') }}</ps-button>
                <ps-button class="" padding="px-8 py-4" rounded="rounded-lg" @click="paymentClicked('PAYSTACK')" >{{ $t('promote_item_modal__pay_with_stack') }}</ps-button>
                <ps-button class="" padding="px-8 py-4" rounded="rounded-lg" @click="paymentClicked('OFFLINE')" >{{ $t('promote_item_modal__pay_with_offline') }}</ps-button>
            </div>
