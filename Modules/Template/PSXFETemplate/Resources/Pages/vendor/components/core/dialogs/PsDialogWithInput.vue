    ...
    <ps-modal ref="psmodal" maxWidth="370px" line="hidden" :isClickOut='false' theme=" px-6 py-6 rounded-lg shadow-xl me-3" class=' z-20'>
        ...
        <template #footer>
            <div class=" flex flex-row justify-end">
                ...
                <ps-button rounded="rounded" @click="actionClicked('yes')" textSize="text-xs lg:text-sm" class="" colors="bg-fePrimary-500 text-white"  hover="hover:outline-none hover:ring hover:ring-red-100" focus="focus:outline-none focus:ring focus:ring-red-300" > {{okButton}} </ps-button>
            </div>
        </template>
    </ps-modal>
</template>
