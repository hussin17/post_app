<template>
    <div v-if="notify">
        <div id="notification-box" class="overflow-hidden flex items-end w-mobile sm:w-median lg:w-64 justify-between leading-none   bg-primary-000 dark:bg-primaryDark-black rounded-t-xl lg:rounded-t-2xl top-0 fixed">
            <a href="#" id="notification-close" @click="closed()" title="close">x</a>
            <div class="bg-primary-000 lg:px-2 py-1 px-1 h-18 cursor-pointer flex-grow flex flex-row items-center no-underline text-black"  @click="clicked(flag)">
