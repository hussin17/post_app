        ...
        <template #body>
            <div class="w-full text-start mt-2">
                    ...
                    <div class="mb-4">
                        ...
                        <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ usernameError }}</ps-label-caption>
                        <!-- <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{ "errors" }}</ps-label-caption> -->
                    </div>
                    <div class="mb-4" v-if="hasPassword == false">
                        ...
                        <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{  passwordError }}</ps-label-caption>
        ...
        <template #footer>
            <div class=" flex flex-row justify-end">
                <ps-button rounded="rounded" @click="actionClicked('no')" textSize="text-xs lg:text-sm" class=" me-4"
                    border="border border-gray-200" colors="bg-none"
                    hover="hover:outline-none hover:ring hover:ring-gray-100"> {{ cancelButton }} </ps-button>
