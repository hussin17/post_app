...
<!--        </template>-->
        ...
        <template #footer>
            <div class=" flex flex-row justify-end">
                <ps-button rounded="rounded" @click="actionClicked('no')" textSize="text-xs lg:text-sm" class=" me-4" border="border border-gray-200" colors="bg-none text-feSecondary-800 dark:text-white" hover="hover:outline-none hover:ring hover:ring-gray-100" > {{cancelButton}} </ps-button>
                <ps-button rounded="rounded" @click="actionClicked('yes')" textSize="text-xs lg:text-sm" class="" colors="bg-fePrimary-500 text-white"  hover="hover:outline-none hover:ring hover:ring-fePrimary-100" focus="focus:outline-none focus:ring focus:ring-fePrimary-300" > {{okButton}} </ps-button>
            </div>
        </template>
    </ps-modal>
</template>
