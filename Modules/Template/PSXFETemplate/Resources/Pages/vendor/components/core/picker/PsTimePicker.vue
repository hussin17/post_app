<template>
    <div class="bg-fePrimary-000 dark:bg-fePrimaryDark-black p-3 lg:rounded-2xl rounded-xl h-auto ms-4">
        <div class="flex">
            <ps-dropdown align="left" class=' w-full' >
                <template #select>
                   <button
                        ...
                        text-sm leading-5 font-medium text-feSecondary-500 dark:text-feSecondaryDark-white
                ...
                <template #list >
                    <div class="rounded-md shadow-xs w-8" >
                        <div class="pt-1 z-30">
                            <div v-for="i in 13" :value="i-1" :key="i-1" class="cursor-pointer text-center text-feSecondary-500 dark:text-feSecondaryDark-white" @click="handleHourInput(('00'+(i-1)).slice(-2))" > 
            ...
            <ps-dropdown align="left" class=' w-full' >
                ...
                <template #list >
                    <div class="rounded-md shadow-xs w-8" >
                        <div class="pt-1 z-30">
                            <div v-for="i in 60" :value="i-1" :key="i-1" class="cursor-pointer text-center text-feSecondary-500 dark:text-feSecondaryDark-white" @click="handleMinuteInput(('00'+(i-1)).slice(-2))" > 
                                <ps-label> {{('00'+(i-1)).slice(-2)}} </ps-label>
                            </div>      
                        </div>
            ...
            <ps-dropdown align="left" h='16' class=' w-full' >
                <template #select>
                   <button
                        ...
                        text-sm leading-5 font-medium text-feSecondary-500 dark:text-feSecondaryDark-white
                                 focus:outline-none focus:border-blue-300 
                                focus:shadow-outline-blue active:bg-gray-100 active:text-feSecondary-600transition 
                                ease-in-out duration-150 btn-focus"
                        id="options-menu"
                        aria-haspopup="true"
                        aria-expanded="true">
                ...
                <template #list >
                    <div class="rounded-md shadow-xs w-10" >
                        <div class="pt-1 z-30">
                            <div class="cursor-pointer text-center text-feSecondary-500 dark:text-feSecondaryDark-white" @click="handleAmPmInput('1')" > 
                                <ps-label> AM </ps-label>
                            </div>
                            <div class="cursor-pointer text-center text-feSecondary-500 dark:text-feSecondaryDark-white" @click="handleAmPmInput('2')" > 
