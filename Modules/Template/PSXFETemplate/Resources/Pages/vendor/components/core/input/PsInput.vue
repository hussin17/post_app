<template>
    <input
        class="block dark:bg-feSecondaryDark-black w-full px-3 py-2 text-sm shadow-sm dark:placeholder-feSecondary-300 placeholder-feSecondary-500"
        :type="type"
        :value="value"
        :disabled="disabled"
        :readonly="readonly"
...
export default {
    ...
    props: {
        ...
        "errorBorder": { type: String, default: "border border-red-500 focus:border-red-500 focus:outline-none focus:border-none focus:ring-1 focus:ring-red-500 ring-red-500 placeholder-feSecondary-500 dark:placeholder-feSecondary-400" },
        "onInput" : Function,
        opacity: {
                type: String,
                default: 'opacity-100'
