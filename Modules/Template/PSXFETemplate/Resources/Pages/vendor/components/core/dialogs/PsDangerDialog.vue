    ...
    <ps-modal ref="psmodal" maxWidth="480px" line="hidden" :isClickOut='false' theme=" px-6 py-6 rounded-lg shadow-xl me-3" class=' z-20'>
        ...
        <template #footer>
            <div class=" flex flex-row justify-end">
                <ps-button rounded="rounded" @click="actionClicked('no')" textSize="text-xs lg:text-sm" class=" me-4" border="border border-gray-200 dark:border-feSecondary-700" colors="bg-none dark:text-feSecondary-100" hover="hover:outline-none hover:ring hover:ring-feSecondary-100 dark:hover:ring-feSecondary-600" > {{cancelButton}} </ps-button>
