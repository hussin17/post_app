    ...
    <ps-modal ref="psmodal" maxWidth="400px" :isClickOut='false' theme=" lg:px-8 px-6 py-6 lg:rounded-2xl rounded-xl" class=' z-20'>
        ...
        <template #footer>
            <div class=" flex flex-row justify-between">
                <ps-button @click="actionClicked('no')" textSize="text-xxs lg:text-sm" class="py-3 " theme="bg-feSecondary-300 dark:bg-feSecondaryDark-grey text-feTextLight dark:text-fePrimaryDark-white"> {{cancelButton}} </ps-button>  
