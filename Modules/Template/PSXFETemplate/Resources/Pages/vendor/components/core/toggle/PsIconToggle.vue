<template>
    <div class="flex items-center">
        <button
            ...
            <span  class="w-4 h-4 rounded-full items-center justify-center flex flex-col bg-background mx-1" >
                <ps-icon w="10" h="10" class="text-feBackground flex-grow-0" :name="toggleValue ? toggleOnIcon : toggleOffIcon" />
            </span>

        </button>

        <!-- <button :class="toggleValue ? 'text-dark':'text-white'" @click="toggle">
