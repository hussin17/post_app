    ...
    <nav class="fixed z-50 w-full h-10 flex items-center bg-feSecondary-900"
        ...
        <div class="xl:w-feLarge lg:w-large w-full flex justify-between mx-4 sm:mx-6 lg:mx-auto">
            <div class="flex items-center cursor-pointer" @click.prevent="openLocationModal">
                ...
                <ps-label textColor="text-feSecondary-200 dark:text-feTextLight" class="text-sm hidden md:block">{{ psValueStore.locationName }}{{ appInfoStore.appInfo.data?.psAppSetting?.isSubLocation == '1' ? `,${psValueStore.subLocationName}` : '' }} </ps-label>
            </div>
            ...
            <div v-if="dataReady" class="flex gap-4" >
                            ...
                            <ps-label class="">
                                <button
                                    ...
                                    class="inline-flex items-center content-start justify-between w-full
                                                ...
                                                ease-in-out duration-150 btn-focus text-white"
                                    ...
                                    <ps-icon name="downArrow" textColor="text-white" class=" ms-2" w='24' h='24' />
                ...
                <div class="flex items-center gap-3">
                    <ps-label textColor="text-feBackground" >Dark</ps-label>
