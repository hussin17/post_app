<template>
    <ps-modal ref="psmodal" :isClickOut="false" maxWidth="472px" theme="rounded-lg p-6 bg-feBackground dark:bg-feSecondary-800" >
        <template #title>
        ...
        <template #footer>
            <div class="flex justify-end">
                <ps-button @click="psmodal.toggle(false)" colors="bg-feBackground text-feSecondary-800 dark:bg-feSecondary-800 dark:text-feSecondary-200" hover="dark:hover:bg-feSecondary-700" border="border"> {{ $t("share_with_social_modal__cancel") }} </ps-button>
            </div>
        </template>
    </ps-modal>
