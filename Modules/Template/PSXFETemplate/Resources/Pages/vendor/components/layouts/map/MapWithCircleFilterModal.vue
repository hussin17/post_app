<template>
    <ps-modal ref="psmodal" line="hidden" bodyHeight="max-h-76" :isClickOut="true" >
        ...
        <template #body>
            ...
            <open-street-map v-if="appInfoStore?.appInfo?.data.frontendConfigSetting.openStreetMap == PsConst.ONE" class="h-68" :lat="map.center.lat" :lng="map.center.lng" :dragValue="false" :onChange="updateLeafletCoordinates" />
