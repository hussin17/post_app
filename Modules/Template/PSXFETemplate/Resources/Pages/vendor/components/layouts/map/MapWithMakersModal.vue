<template>
    <ps-modal ref="psmodal" maxWidth="370px" :isClickOut='false' line="hidden" theme= "bg-feBackground dark:bg-feSecondary-800 lg:px-6 px-4 py-6 rounded-x " class=' z-20'>
        <template #title>
            <div class="flex flex-row justify-between mb-3">
                ...
                <font-awesome-icon @click="psmodal.toggle(false)" :icon="['fas', 'times']" class="text-feSecondary-800 dark:text-feSecondary-200" size="x" />
            </div>
        </template>
        <template #body>
        ...
        <template #footer>
            ...
            <div class="flex justify-between  rtl:space-x-reverse space-x-4">
                <ps-secondary-button @click="reset" class="w-full" >
