            ...
            <div class="sm:mt-32 lg:mt-36 mt-28">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center">
                    ...
                    <div class="flex justify-end content-center items-center w-full">
                        <ps-input-with-right-icon v-on:keyup.enter="searchClicked" v-model:value="categoryStore.paramHolder.keyword" class="sm:w-80 w-full" padding="py-2 px-4 h-10" v-bind:placeholder="$t('category__search')" >
                            <template #icon>
                        ...
                        <ps-dropdown horizontalAlign="right" h="h-auto" class="ms-4" >
                            <template #select>
                                <ps-dropdown-select class="h-10 w-10 sm:w-auto sm:ps-4 ps-2.5" leftIcon="filter" leftIconTheme="text-white sm:me-2 me-0" bgColor="bg-fePrimary-500" text="text-sm font-medium text-white hidden sm:inline" iconTheme="text-white ms-2 hidden sm:inline" :selectedValue="activeSortingName" placeholder="Sort" />
                            </template>
                            <template #list>
                                <div
                                    class="rounded-md bg-feBackground dark:bg-feSecondary-800 shadow-xs w-44"
                                    role="menu"
