    ...
    <ps-content-container>
        <template #content>
            <div class="sm:mt-32 lg:mt-36 mt-28 mb-16">
                ...
                <div class="">
                    <div class="w-full flex flex-col  border rounded-md border-feSecondary-400 dark:border-feSecondaryDark-grey py-6 sm:py-10 md:py-12 lg:py-16 px-6 sm:px-10 md:px-12 lg:px-24">
                        <div class="flex w-full items-center justify-center sm:items-start sm:justify-start">
                            <div class="mx-2 w-48 h-44 sm:w-52 sm:h-48 rounded-full  relative" >
                                ...
                                <div class="absolute end-0 mt-18 sm:mt-20 z-20 cursor-pointer bg-secondaryDark-black text-white p-2 rounded-full" @click="onImageClick" for="upload-image1">
                                ...
                                <div class="relative w-44 h-44 sm:w-48 sm:h-48 rounded-full overflow-hidden flex items-center justify-center">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-center mt-4 sm:mt-12 md:mt-16 lg:mt-20 mb-6 sm:mb-8">
                            ...
                            <ps-button class="text-center w-64 mt-4 sm:mt-0"
                             colors="bg-feSecondary-500 text-white" 
