        ...
        <div class=" sm:mt-32 lg:mt-36 mt-28  flex flex-col">
            ...
            <div class=" w-55 lg:w-80 flex flex-col mx-auto rounded-lg">
                ...
                <div class="flex flex-auto justify-center mt-3">
                    <ps-label textColor="text-feSecondary-400 dark:text-feSecondaryDark-grey" class='cursor-pointer  font-light text-xs lg:text-sm' @click="loginClicked">  {{ $t("register__already_member_login") }}  </ps-label>
                </div>
                ...
                <ps-button textSize="text-xs lg:text-base" class="mt-3 lg:mt-4 py-3 flex justify-center mb-2" theme="bg-yellow-600 hover:bg-yellow-700 text-feTextLight px-4 py-2"  id="signinBtn" @click="googleloginclicked">
