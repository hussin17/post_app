<template>
    ...
    <div class=" sm:mt-28 lg:mt-28 mt-28 bg-fePrimary-500 dark:bg-fePrimaryDark-accent  h-screen flex flex-col">

        <div class=" mt-56 w-96 flex flex-col mx-auto bg-feBackground dark:bg-feBackgroundDark  m-auto rounded-lg">
            ...
            <ps-label-caption v-if="isValidUserName" class="mt-2 mx-8" textColor="text-fePrimary-500 dark:text-fePrimaryDark-accent" >{{ $t("phone_login__user_name_required") }}</ps-label-caption>
            ...
            <ps-label-caption v-if="isValidPhone" class="mt-2 mx-8" textColor="text-fePrimary-500 dark:text-fePrimaryDark-accent" >{{ $t("phone_login__phone_required") }}</ps-label-caption>
