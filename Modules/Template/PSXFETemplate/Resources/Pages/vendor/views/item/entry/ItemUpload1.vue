<template>
    <div class='sm:mt-32 lg:mt-36 mt-28 w-mobile sm:w-median lg:w-large mx-auto' v-if="itemId == '0' || dataReady == true">
        ...
        <div
            class="w-full grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4 mt-2 bg-feSecondary-50 dark:bg-secondaryDark-black">
                        ...
                        <div class="flex flex-wrap" v-for='index in imageCount' :key='index'>
                            <div v-if="index == 1" class="me-2 mt-2 w-20 relative">
                                ...
                                <div @click="defaultClick(index)"
                                    class="cursor-pointer bg-fePrimary-000 w-20 h-20 rounded-2xl flex items-center justify-center absolute">
                                ...
                                <ps-label
                                    class=" relative w-full mt-14 text-center pt-1 text-textLight h-6 rounded-b-xl bg-secondary-500 dark:text-textDark dark:bg-secondaryDark-accent opacity-90"
                            ...
                            <div v-else class="me-2 mt-2 w-20 relative" for="upload-image3">
                                ...
                                <div @click="imageDelete(index)"
                                    ...
                                    class="cursor-pointer relative mt-14 ms-11 bg-fePrimary-000 rounded-full dark:bg-fePrimaryDark-black  py-1.5 px-2.5">

                                    <font-awesome-icon :icon="['fas', 'trash-alt']"
                                        class=" text-secondary-500 dark:text-secondaryDark-white lg:text-base text-sm" />
                                </div>


                            </div>
                        </div>
                        <ps-label class="lg:mt-2 mt-1  w-full text-xs" textColor="text-red-500"
            ...
            <div class=" col-span-12 mt-4 lg:px-8  md:px-8 md:col-start-1 sm:col-start-2 px-6 w-full" v-if="galleryLoad">
                ...
                <Dropzone @clicked="pushImage" @removeImage="removeImage" @caption="caption" @maxfilesexceeded="maxUpload"
                ...
                <ps-label class="lg:mt-2 mt-1  w-full text-xs " textColor="text-red-500" v-if="validation.imageStatus"> {{
                    $t("item_entry__image_required_error") }} </ps-label>
                <ps-label class="lg:mt-2 mt-1  w-full text-xs " textColor="text-red-500" v-if="validation.maxImgExceed"> {{
                ...
                <div class="flex">
                    <div class="mt-2 w-20 h-20 relative cursor-pointer" for="upload-video">
                        ...
                        <div @click="onVideoClick"
                            class="bg-fePrimary-000 w-20 h-20 rounded-2xl flex items-center justify-center absolute">
                        ...
                        <div @click="videoDelete()" v-if="previewVideo.data != '' || getVideoUrl() != ''"
                            class="cursor-pointer relative mt-14 ms-11 bg-fePrimary-000 rounded-full dark:bg-fePrimaryDark-black  py-1.5 px-2.5">
                            <font-awesome-icon :icon="['fas', 'trash-alt']"
                                class=" text-feSecondary-500 dark:text-feSecondaryDark-white lg:text-base text-sm" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full grid  grid-cols-12 gap-4 sm:gap-3.5 lg:gap-4 bg-feSecondary-50  dark:bg-secondaryDark-black">
            <!-- Start Left Screen -->
            <div class="col-span-12  mt-4  lg:px-8  md:px-8 md:col-start-1 sm:col-start-2 px-6 w-full">
                <div class=" w-full">
                                            ...
                                            <div class="pt-2 z-30">
                                                <div v-if="subCategoryStore.subCategoryList.data == null">
                                                    <div
                                                        ...
                                                        <ps-label class='p-2 flex' textColor="text-red-500"> {{
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex flex-row items-center  mt-2">
                            <div class=""
                                ...
                                <ps-label class="  w-full text-xs" textColor="text-red-500"
                        ...
                        <ps-label class="mt-1  w-full text-xs" textColor="text-red-500" v-if="validation.priceStatus"> {{
                    ...
                    <div v-for="customFieldHeader in customFieldStore.customField.data?.customList"
                        ...
                        <div class=" mb-4"
                            ...
                            <ps-label textColor="text-red-500 " class="lg:mt-2 mt-1  w-full text-xs">{{
                        ...
                        <div class=" mb-4"
                            ...
                            <ps-label>{{ $t(customFieldHeader.name) }}<span class="text-red-800 font-medium ms-1"
                                    v-show="customFieldHeader.mandatory == '1'">*</span></ps-label>
                        ...
                        <!-- <div class=" mb-4" v-if="customFieldHeader.uiType.coreKeysId === 'uit00009' && customFieldHeader.isVisible === '1' && customFieldHeader.isDelete === '0'">
                                <ps-label class="text-base">{{ $t(customFieldHeader.name) }}<span class="text-red-800 font-medium ms-1" v-show="customFieldHeader.mandatory ===1">*</span></ps-label>
                                <div v-if="item.image" class="flex items-end pt-4">
                                    ...
                                    <ps-button type="button" @click="replaceImageClicked(item.image.id)" rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2" colors="bg-white text-fePrimary-500 dark:bg-secondaryDark-black" border="border border-1 dark:border-secondary-700 border-secondary-300" padding="p-1.5" hover="" focus="">
                                    ...
                                    <template #filter>
                                        <div class="w-56">
                                            <ps-input-with-right-icon class="rounded-xl flex-1 "
                                                ...
                                                <template #icon>
                                                    <ps-icon textColor="text-feSecondary-400 dark:text-feSecondaryDark-grey"
                                                        name="search" class='cursor-pointer'
                ...
                <div class="w-full ">
                    <!-- <ps-button class="lg:mt-5 mt-4 mb-5 text-center w-full " textSize="lg:text-sm sm:text-xs text-xs" theme="bg-fePrimary-500 dark:bg-fePrimaryDark-accent text-feTextLight dark:text-feTextDark py-1" @click="locatorButtonPress"> CurrentLoc </ps-button> -->
                    <ps-button v-if="itemId == '0'" class="lg:mt-5 mt-4 mb-5 text-center w-full "
                        textSize="lg:text-sm sm:text-xs text-xs"
                        theme="bg-fePrimary-500 dark:bg-fePrimaryDark-accent text-feTextLight dark:text-feTextDark py-1"
                    ...
                    <ps-button textSize="lg:text-sm sm:text-xs text-xs"
                        colors="bg-white dark:bg-backgroundDark dark:text-white "
                    ...
                    <!-- <ps-button class="lg:mt-5 mt-4 mb-5 text-center w-full "
                        textSize="lg:text-sm sm:text-xs text-xs"
                        theme="bg-white dark:bg-fePrimaryDark-accent text-feTextLight dark:text-feTextDark py-1"
...
export default {
    ...
    props: ['thumb2xUrl', 'authUser', 'sysImageUrl', 'itemId'],
    setup(props) {
        ...
        async function loadItemForEdit() {
            ...
            if (item.status == PsStatus.SUCCESS) {
                ...
                gallery.value = await galleryProvider.loadGalleryList(appInfoStore.appInfo.data.frontendConfigSetting.isEnableVideoSetting, loginUserId, itemId, PsConst.ITEM_TYPE, null);
