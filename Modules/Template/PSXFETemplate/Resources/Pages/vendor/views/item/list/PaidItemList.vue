<template>
    <Head :title="$t('profile__paid_item_list')"/>
    <ps-content-container>
        <template #content>
            <div class="mt-32 mb-10">
                ...
                <ps-label-header-4 class="font-semibold mt-6">{{ $t('profile__paid_item_list')}}</ps-label-header-4>
    ...
    computed: {
        breadcrumb() {
            return [
                ...
                {
                    label: trans('profile__paid_item_list'),
