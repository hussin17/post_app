    ...
    <div class="sm:mt-32 lg:mt-36 mt-28 mb-16 w-mobile sm:w-median lg:w-large mx-auto">
        <div class="grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4 ">
            ...
            <div class="col-start-0 col-span-4 sm:col-span-2 lg:col-span-3" >
                ...
                <div class=" ">
                    <div class=" flex flex-row  rtl:space-x-reverse space-x-3.5 sm:space-x-0 space-y-0 sm:space-y-3.5 sm:flex-col" id="sellerbtn" v-if="isSellerFocus" :disabled="true">
                        ...
                        <ps-button class="w-full" theme="dark:bg-feSecondary-100 dark:text-feTextLight bg-fePrimary-000 text-fePrimary-400" @click="buyerClicked">
                    ...
                    <div class="flex flex-row  rtl:space-x-reverse space-x-3.5 sm:space-x-0 space-y-0 sm:space-y-3.5 sm:flex-col" id="buyerbtn"  v-else :disabled="true">
                        <ps-button class="w-full" theme='dark:bg-feSecondary-100 dark:text-feTextLight bg-fePrimary-000 text-fePrimary-400' @click="sellerClicked" >
                            {{ $t("offer_list__offer_sent") }}
                        </ps-button>
            ...
            <div class="col-span-4 sm:col-span-6 lg:col-span-9">
                ...
                <div v-if="ps_loading">
                    <div id="seller" class="w-full flex flex-col bg-fePrimary-000 dark:bg-fePrimaryDark-black lg:p-4 p-2 sm:p-3 rounded-2xl" >
                        <div class='w-full ' >
                ...
                <div id="seller" class="flex flex-row mb-16" v-if="isSellerFocus && ps_loading == false">
                    ...
                    class="w-full flex flex-col bg-fePrimary-000 dark:bg-fePrimaryDark-black lg:p-4 p-2 sm:p-3 rounded-2xl">
                       <ps-icon name="mailOpen" textColor="text-feSecondary-400 dark:text-feSecondaryDark-grey"  class='mt-2 w-full mx-auto' w="80" h="80" />
                       <ps-label-caption-3 class="text-center mb-2" >{{ $t("offer_list__nothing_in_offer_sent") }} </ps-label-caption-3>

                    </div>
                    <div v-else class='w-full flex flex-col bg-fePrimary-000 dark:bg-fePrimaryDark-black lg:p-4 p-2 sm:p-3 rounded-2xl' >
                ...
                <div id="buyer" class="flex flex-row mb-16 " v-else-if="ps_loading == false">
                    ...
                    <div v-else class='w-full ' >
                        <div class="w-full flex flex-col bg-fePrimary-000 dark:bg-fePrimaryDark-black lg:p-4 p-2 sm:p-3 rounded-2xl ">
                            <!-- Column -->
