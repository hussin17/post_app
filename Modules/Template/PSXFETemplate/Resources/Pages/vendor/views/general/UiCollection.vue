    ...
    <ps-content-container>
        <template #content>
            <div class="flex flex-col mt-36">
                ...
                <ps-input-group class="w-80 h-9 mb-4"
                    ...
                    <template #leftButton>
                        <ps-dropdown >
                            <template #select>
                                <ps-dropdown-select border="border border-e-secondary-200" rounded="rounded-l" :selectedValue=" 'Label ' + selectedIndex" w="w-26 h-9"  />
                            </template>
                            <template #filter>
                            ...
                            <template #list>
                                <div
                                    class="rounded-md bg-feBackground dark:bg-feSecondary-800 shadow-xs w-32"
                                    role="menu"
            ...
            <ps-textarea class="mb-4" rows="4" placeholder="Enter Text"></ps-textarea>
                ...
                <div class="flex flex-row  rtl:space-x-reverse space-x-4 mb-4">
                    <ps-secondary-button class="mt-2"> {{ $t('ui_collection__primary_button') }}  </ps-secondary-button>
                    <ps-secondary-button class="mt-2 " :disabled="true"> {{ $t('ui_collection__disabled_button') }}  </ps-secondary-button>
                </div>
                ...
                <ps-checkbox v-for=" selectData  in checkedDataList"
                    ...
                    class="focus:bg-fePrimary-500 dark:bg-fePrimaryDark-accent" > {{selectData.name}} </ps-checkbox>
                ...
                <div class="flex items-center mt-4" id="r1">
                    ...
                    :title="selectData.name"
                    class="focus:bg-fePrimary-500 dark:bg-fePrimaryDark-accent me-4"></ps-radio>
                </div>
                ...
                <div class="flex justify-between mb-4">
                    ...
                    <ps-dropdown align="right"  >
                        ...
                        <template #list>
                            <div
                                class="rounded-md bg-feBackground dark:bg-feSecondary-800 shadow-xs"
                                role="menu"
                                aria-orientation="vertical"
                                aria-labelledby="options-menu">
                                <div class="pt-2">
                                ...
                                <div class="pt-2">
                                    <div v-for="i in 5" :key="i" class="flex py-4 px-2 hover:bg-red-100 cursor-pointer items-center"  @click="onItemClick(i)" >
                                        ...
                                        <img  width="300px" height="200px" alt="Placeholder"
                                            ...
                                            class="h-6 w-6"
                                        />
                                        <span class="ms-2" :class="i==selectedIndex ? 'text-red-500' : 'text-fePrimary-500'"  > {{ $t("ui_collection__transaction_history") }} {{i}} </span>
